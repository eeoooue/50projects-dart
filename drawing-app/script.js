...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    SizePicker$(app, decreaseBtn, increaseBtn) {
      var t1 = new A.SizePicker(app, decreaseBtn, increaseBtn);
      t1.SizePicker$3(app, decreaseBtn, increaseBtn);
      return t1;
    },
    ColourPicker$(app, element) {
      var t1 = new A.ColourPicker(app, element);
      t1.ColourPicker$2(app, element);
      return t1;
    },
    ClearButton$(app, element) {
      var t1 = new A.ClearButton(app, element);
      t1.ClearButton$2(app, element);
      return t1;
    },
    main() {
      var app, increaseBtn, decreaseBtn, t2, colorEl, clearEl,
        t1 = document,
        canvas = t1.getElementById("canvas");
      if (type$.CanvasElement._is(canvas)) {
        app = new A.DrawingApp(canvas);
        app.__DrawingApp_ctx_A = B.CanvasElement_methods.getContext$1(canvas, "2d");
        app.armCanvas$0();
        increaseBtn = t1.getElementById("increase");
        decreaseBtn = t1.getElementById("decrease");
        t2 = type$.ButtonElement;
        if (t2._is(increaseBtn) && t2._is(decreaseBtn))
          A.SizePicker$(app, decreaseBtn, increaseBtn);
        colorEl = t1.getElementById("color");
        if (type$.InputElement._is(colorEl))
          A.ColourPicker$(app, colorEl);
        clearEl = t1.getElementById("clear");
        if (t2._is(clearEl))
          A.ClearButton$(app, clearEl);
      }
    },
    DrawingApp: function DrawingApp(t0) {
      var _ = this;
      _.canvas = t0;
      _.size = 10;
      _.__DrawingApp_ctx_A = $;
      _.y = _.x = 0;
      _.isPressed = false;
      _.colour = "#000000";
    },
    DrawingApp_armCanvas_closure: function DrawingApp_armCanvas_closure(t0) {
      this.$this = t0;
    },
    DrawingApp_armCanvas_closure0: function DrawingApp_armCanvas_closure0(t0) {
      this.$this = t0;
    },
    DrawingApp_armCanvas_closure1: function DrawingApp_armCanvas_closure1(t0) {
      this.$this = t0;
    },
    SizePicker: function SizePicker(t0, t1, t2) {
      this.app = t0;
      this.decreaseBtn = t1;
      this.increaseBtn = t2;
    },
    SizePicker_closure: function SizePicker_closure(t0) {
      this.$this = t0;
    },
    SizePicker_closure0: function SizePicker_closure0(t0) {
      this.$this = t0;
    },
    ColourPicker: function ColourPicker(t0, t1) {
      this.app = t0;
      this.element = t1;
    },
    ColourPicker_closure: function ColourPicker_closure(t0) {
      this.$this = t0;
    },
    ClearButton: function ClearButton(t0, t1) {
      this.app = t0;
      this.element = t1;
    },
    ClearButton_closure: function ClearButton_closure(t0) {
      this.$this = t0;
    },
  ...
  A.CanvasRenderingContext2D.prototype = {
    ...
    moveTo$2(receiver, x, y) {
      return receiver.moveTo(x, y);
    },
    arc$5(receiver, x, y, radius, startAngle, endAngle) {
  ...
  A.DrawingApp.prototype = {
    armCanvas$0() {
      var t2, _this = this,
        t1 = _this.canvas;
      B.CanvasElement_methods.addEventListener$2(t1, "mousedown", new A.DrawingApp_armCanvas_closure(_this));
      t2 = document;
      t2.toString;
      B.HtmlDocument_methods.addEventListener$2(t2, "mouseup", new A.DrawingApp_armCanvas_closure0(_this));
      B.CanvasElement_methods.addEventListener$2(t1, "mousemove", new A.DrawingApp_armCanvas_closure1(_this));
    },
    changeSize$1(amount) {
      var span, _this = this,
        t1 = _this.size += amount;
      _this.set$size(0, Math.max(t1, 5));
      _this.set$size(0, Math.min(_this.size, 50));
      span = document.getElementById("size");
      if (type$.Element._is(span))
        span.innerText = B.JSInt_methods.toString$0(_this.size);
    },
    set$size(_, size) {
      this.size = A._asInt(size);
    }
  };
  A.DrawingApp_armCanvas_closure.prototype = {
    call$1($event) {
      var t1, t2;
      ...
      if (type$.MouseEvent._is($event)) {
        ...
        t1.x = t2.get$offset($event).x;
        t1.y = t2.get$offset($event).y;
      }
    },
    $signature: 0
  };
  A.DrawingApp_armCanvas_closure0.prototype = {
    call$1($event) {
      var t1;
      type$.Event._as($event);
      t1 = this.$this;
  ...
  A.DrawingApp_armCanvas_closure1.prototype = {
    call$1($event) {
      var t1, x2, y2, t2, t3;
      type$.Event._as($event);
      if (type$.MouseEvent._is($event) && this.$this.isPressed) {
        t1 = J.getInterceptor$x($event);
        x2 = t1.get$offset($event).x;
        y2 = t1.get$offset($event).y;
        t1 = this.$this;
        t2 = t1.__DrawingApp_ctx_A;
        t2 === $ && A.throwLateFieldNI("ctx");
        J.beginPath$0$x(t2);
        J.arc$5$x(t1.__DrawingApp_ctx_A, x2, y2, t1.size, 0, 6.283);
        J.set$fillStyle$x(t1.__DrawingApp_ctx_A, t1.colour);
        J.fill$0$x(t1.__DrawingApp_ctx_A);
        t2 = t1.x;
        t3 = t1.y;
        J.beginPath$0$x(t1.__DrawingApp_ctx_A);
        J.moveTo$2$x(t1.__DrawingApp_ctx_A, t2, t3);
        J.lineTo$2$x(t1.__DrawingApp_ctx_A, x2, y2);
        J.set$strokeStyle$x(t1.__DrawingApp_ctx_A, t1.colour);
        J.set$lineWidth$x(t1.__DrawingApp_ctx_A, t1.size * 2);
        J.stroke$0$x(t1.__DrawingApp_ctx_A);
        t1.x = x2;
        t1.y = y2;
      }
    },
  ...
  A.SizePicker.prototype = {
    SizePicker$3(app, decreaseBtn, increaseBtn) {
      var _this = this;
      B.ButtonElement_methods.addEventListener$2(_this.decreaseBtn, "click", new A.SizePicker_closure(_this));
      B.ButtonElement_methods.addEventListener$2(_this.increaseBtn, "click", new A.SizePicker_closure0(_this));
    }
  };
  A.SizePicker_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      return this.$this.app.changeSize$1(-5);
    },
    $signature: 1
  };
  A.SizePicker_closure0.prototype = {
    call$1($event) {
      type$.Event._as($event);
      return this.$this.app.changeSize$1(5);
    },
  ...
  A.ColourPicker.prototype = {
    ColourPicker$2(app, element) {
      B.InputElement_methods.addEventListener$2(this.element, "change", new A.ColourPicker_closure(this));
    }
  };
  A.ColourPicker_closure.prototype = {
    call$1($event) {
      var t1, val;
      type$.Event._as($event);
      t1 = this.$this;
      val = t1.element.value;
      if (typeof val == "string")
        t1.app.colour = val;
    },
    $signature: 0
  };
  A.ClearButton.prototype = {
    ClearButton$2(app, element) {
      B.ButtonElement_methods.addEventListener$2(this.element, "click", new A.ClearButton_closure(this));
    }
  };
  A.ClearButton_closure.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.$this.app;
      ...
      t2 === $ && A.throwLateFieldNI("ctx");
      t1 = t1.canvas;
      J.clearRect$4$x(t2, 0, 0, t1.width, t1.height);
      return null;
    },
    $signature: 1
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._Exception, A.Null, A.StringBuffer, A._DOMWindowCrossFrame, A.Point, A.DrawingApp, A.SizePicker, A.ColourPicker, A.ClearButton]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.DrawingApp_armCanvas_closure, A.DrawingApp_armCanvas_closure0, A.DrawingApp_armCanvas_closure1, A.SizePicker_closure, A.SizePicker_closure0, A.ColourPicker_closure, A.ClearButton_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.CanvasElement, A.FormElement, A.InputElement, A.SelectElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Null(Event)", "~(Event)", "@(@)", "@(@,String)", "@(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","ShadowRoot":"Node","DocumentFragment":"Node","XmlDocument":"Document","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"Closure":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"int":{"num":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"ButtonElement":{"Element":[],"EventTarget":[]},"CanvasElement":{"Element":[],"EventTarget":[]},"CharacterData":{"EventTarget":[]},"Document":{"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"HtmlDocument":{"EventTarget":[]},"InputElement":{"Element":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"SelectElement":{"Element":[],"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"WindowBase":[],"EventTarget":[]},"_DOMWindowCrossFrame":{"WindowBase":[],"EventTarget":[]}}'));
