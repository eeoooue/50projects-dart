...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.Timer_Timer(new A.Duration(2500000), new A.main_closure());
    },
    getData() {
      var t2, t3, t4, animated_bgs, animated_bg_texts, header, title, excerpt, profile_img, $name, date,
        _s16_ = "querySelectorAll",
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", _s16_);
      t3 = t1.querySelectorAll(".animated-bg");
      t3.toString;
      t4 = type$._FrozenElementList_Element;
      animated_bgs = new A._FrozenElementList(t3, t4);
      A.checkTypeBound(t2, t2, "T", _s16_);
      t2 = t1.querySelectorAll(".animated-bg-text");
      t2.toString;
      animated_bg_texts = new A._FrozenElementList(t2, t4);
      header = t1.getElementById("header");
      title = t1.getElementById("title");
      excerpt = t1.getElementById("excerpt");
      profile_img = t1.getElementById("profile_img");
      $name = t1.getElementById("name");
      date = t1.getElementById("date");
      if (header != null)
        J.setInnerHtml$2$validator$x(header, '<img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80" alt="" />', new A.AllowAll());
      if (profile_img != null)
        J.setInnerHtml$2$validator$x(profile_img, '<img src="https://randomuser.me/api/portraits/men/45.jpg" alt="" />', new A.AllowAll());
      if (title != null)
        J.setInnerHtml$1$x(title, "Lorem ipsum dolor sit amet");
      if (excerpt != null)
        J.setInnerHtml$1$x(excerpt, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore perferendis");
      if ($name != null)
        J.setInnerHtml$1$x($name, "John Doe");
      if (date != null)
        J.setInnerHtml$1$x(date, "Oct 08, 2020");
      for (t1 = t4._eval$1("ListIterator<ListBase.E>"), t2 = new A.ListIterator(animated_bgs, animated_bgs.get$length(animated_bgs), t1), t4 = t4._eval$1("ListBase.E"); t2.moveNext$0();) {
        t3 = t2.__internal$_current;
        J.get$classes$x(t3 == null ? t4._as(t3) : t3).remove$1(0, "animated-bg");
      }
      for (t1 = new A.ListIterator(animated_bg_texts, animated_bg_texts.get$length(animated_bg_texts), t1); t1.moveNext$0();) {
        t2 = t1.__internal$_current;
        J.get$classes$x(t2 == null ? t4._as(t2) : t2).remove$1(0, "animated-bg-text");
      }
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A.Element_Element$html_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A.CssClassSetImpl_add_closure]);
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.main_closure]);
