...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    JokeSystem$(element, button) {
      var t1 = new A.JokeSystem(element, button);
      t1.JokeSystem$2(element, button);
      return t1;
    },
    main() {
      var t1 = document,
        jokeEl = t1.getElementById("joke"),
        jokeBtn = t1.getElementById("jokeBtn");
      if (type$.Element._is(jokeEl) && type$.ButtonElement._is(jokeBtn))
        A.JokeSystem$(jokeEl, jokeBtn);
    },
    JokeSystem: function JokeSystem(t0, t1) {
      this.element = t0;
      this.button = t1;
    },
    JokeSystem_closure: function JokeSystem_closure(t0) {
      this.$this = t0;
    },
  ...
  A.JokeSystem.prototype = {
    JokeSystem$2(element, button) {
      B.ButtonElement_methods.addEventListener$2(this.button, "click", new A.JokeSystem_closure(this));
      this.generateJoke$0();
    },
    generateJoke$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1, config, res;
      var $async$generateJoke$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.String;
              config = A.LinkedHashMap_LinkedHashMap$_literal(["headers", A.LinkedHashMap_LinkedHashMap$_literal(["Accept", "application/json"], t1, t1)], t1, type$.Map_String_String);
              $async$goto = 2;
              return A._asyncAwait(A.get(A.Uri_parse("https://icanhazdadjoke.com"), config.$index(0, "headers")), $async$generateJoke$0);
            case 2:
              // returning from await.
              res = $async$result;
              if (res.statusCode === 200)
                $async$self.element.innerText = A._asString(J.$index$asx(B.C_JsonCodec.decode$1(0, A.encodingForCharset(A._contentTypeForHeaders(res.headers).parameters._map.$index(0, "charset")).decode$1(0, res.bodyBytes)), "joke"));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$generateJoke$0, $async$completer);
    }
  };
  A.JokeSystem_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      return this.$this.generateJoke$0();
    },
    $signature: 46
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 8);
    ...
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 34);
    _instance_0_u(A._DoneStreamSubscription.prototype, "get$_sendDone", "_sendDone$0", 0);
    _static_2(A, "collection___defaultEquals$closure", "_defaultEquals", 7);
    _static_1(A, "collection___defaultHashCode$closure", "_defaultHashCode", 6);
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 8);
    var _;
    _instance_1_i(_ = A._ByteCallbackSink.prototype, "get$add", "add$1", 18);
    _instance_0_i(_, "get$close", "close$0", 0);
    _static_1(A, "core__identityHashCode$closure", "identityHashCode", 6);
    _static_2(A, "core__identical$closure", "identical", 7);
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 13);
    _instance_2_i(A.HttpRequest.prototype, "get$setRequestHeader", "setRequestHeader$2", 16);
