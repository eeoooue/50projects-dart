...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _EventStreamSubscription$(_target, _eventType, onData, _useCapture, $T) {
      ...
      if (t2 && true) {
        ...
        if (t2)
          B.HttpRequest_methods._addEventListener$3(_target, _eventType, t1, false);
      }
    ...
    PokePalette$() {
      var t1 = type$.dynamic,
        t2 = type$.String;
      return new A.PokePalette(A.HashMap_HashMap$from(A.LinkedHashMap_LinkedHashMap$_literal(["fire", "#FDDFDF", "grass", "#DEFDE0", "electric", "#FCF7DE", "water", "#DEF3FD", "ground", "#f4e7da", "rock", "#d5d5d4", "fairy", "#fceaff", "poison", "#98d7a5", "bug", "#f8d5a3", "dragon", "#97b3e6", "psychic", "#eaeda1", "flying", "#F5F5F5", "fighting", "#E6E0D4", "normal", "#F5F5F5"], t1, t1), t2, t2));
    },
    main() {
      var t1,
        container = document.getElementById("poke-container");
      if (type$.Element._is(container)) {
        t1 = J.JSArray_JSArray$growable(0, type$.PokemonCard);
        new A.Pokedex(t1, container, A.PokePalette$()).loadPokedex$0();
      }
    },
    AllowAll: function AllowAll() {
    },
    PokePalette: function PokePalette(t0) {
      this.colours = t0;
    },
    Pokedex: function Pokedex(t0, t1, t2) {
      this.cards = t0;
      this.container = t1;
      this.palette = t2;
    },
    PokemonCard: function PokemonCard(t0, t1, t2, t3) {
      var _ = this;
      _.id = t0;
      _.name = t1;
      _.types = t2;
  ...
  A.PokePalette.prototype = {
    getColour$1(type) {
      var result = this.colours.$index(0, type);
      if (result != null)
        return result;
      return "#F5F5F5";
    }
  ...
  A.Pokedex.prototype = {
    loadPokedex$0() {
      var $async$goto = 0,
        ...
        $async$self = this, i;
      var $async$loadPokedex$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              B.JSArray_methods.clear$0($async$self.cards);
              i = 1;
            case 2:
              // for condition
              if (!(i <= 150)) {
              ...
              $async$goto = 5;
              return A._asyncAwait($async$self.getPokemon$1(i), $async$loadPokedex$0);
            case 5:
            ...
            case 4:
              // after for
              $async$self.populateElements$0();
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$loadPokedex$0, $async$completer);
    },
    getPokemon$1(id) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, data, t1, $name, types, $async$temp1;
      var $async$getPokemon$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.HttpRequest_getString("https://pokeapi.co/api/v2/pokemon/" + id), $async$getPokemon$1);
            case 3:
              // returning from await.
              $async$goto = 2;
              return A._asyncAwait($async$temp1.decode$1(0, $async$result), $async$getPokemon$1);
            case 2:
              // returning from await.
              data = $async$result;
              t1 = J.getInterceptor$asx(data);
              $name = A._asString(t1.$index(data, "name"));
              types = J.JSArray_JSArray$growable(0, type$.String);
              for (t1 = J.get$iterator$ax(type$.Iterable_dynamic._as(t1.$index(data, "types"))); t1.moveNext$0();)
                B.JSArray_methods.add$1(types, A._asString(J.$index$asx(J.$index$asx(t1.get$current(), "type"), "name")));
              B.JSArray_methods.add$1($async$self.cards, new A.PokemonCard(id, $name, types, A.PokePalette$()));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$getPokemon$1, $async$completer);
    },
    populateElements$0() {
      var t3, t4, _i, card,
        t1 = this.container,
      ...
      for (t3 = this.cards, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, A.throwConcurrentModificationError)(t3), ++_i) {
        card = t3[_i];
        t2.get$children(t1).add$1(0, card.createElement$0(0));
      }
    }
  };
  A.PokemonCard.prototype = {
    createElement$0(_) {
      var buffer, type, t2, t3, t4, t5, _i, option, _this = this,
        card = document.createElement("div"),
        t1 = J.getInterceptor$x(card);
      t1.get$classes(card).add$1(0, "pokemon");
      ...
      while (true) {
        ...
        option = t2[_i];
        if (t5.containsKey$1(option)) {
          type = option;
          break;
        }
        t2.length === t3 || (0, A.throwConcurrentModificationError)(t2);
        ++_i;
      }
      t2 = card.style;
      t2.toString;
      t4 = t4.getColour$1(type);
      t2.backgroundColor = t4;
      t2 = buffer._contents += '<div class="img-container">';
      t3 = _this.name;
      t2 += '<img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/' + _this.id + '.png"" alt="' + t3 + '">';
      buffer._contents = t2;
      t2 += "</div>";
      buffer._contents = t2;
      t2 += '<div class="info">';
      buffer._contents = t2;
      t2 += '<span class="number">' + _this.getIdString$0() + "</span>";
      buffer._contents = t2;
      if (0 >= t3.length)
        return A.ioore(t3, 0);
      t3 = t2 + ('<h3 class="name">' + (t3[0].toUpperCase() + B.JSString_methods.substring$1(t3, 1)) + "</h3>");
      buffer._contents = t3;
      t3 += '<small class="type">Type: <span>' + type + "</span></small>";
      buffer._contents = t3;
      t3 = buffer._contents = t3 + "</div>";
      t1.setInnerHtml$2$validator(card, t3.charCodeAt(0) == 0 ? t3 : t3, new A.AllowAll());
      return card;
    },
    getIdString$0() {
      var textForm = B.JSInt_methods.toString$0(this.id);
      for (; textForm.length < 3;)
        textForm = "0" + textForm;
      return "#" + textForm;
    }
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A.AllowAll, A.PokePalette, A.Pokedex, A.PokemonCard]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      PokemonCard: findType("PokemonCard"),
