...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DirectionalBtn$(carousel, element, change) {
      var t1 = new A.DirectionalBtn();
      t1.DirectionalBtn$3(carousel, element, change);
      return t1;
    },
    main() {
      var t2, carousel, leftBtn, rightBtn,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t2 = t1.querySelectorAll("#imgs img");
      t2.toString;
      carousel = new A.ImageCarousel(new A._FrozenElementList(t2, type$._FrozenElementList_Element));
      carousel.startTimer$0();
      leftBtn = t1.getElementById("left");
      if (leftBtn != null)
        A.DirectionalBtn$(carousel, leftBtn, -1);
      rightBtn = t1.getElementById("right");
      if (rightBtn != null)
        A.DirectionalBtn$(carousel, rightBtn, 1);
    },
    ImageCarousel: function ImageCarousel(t0) {
      this.position = 0;
      this.images = t0;
      this.timer = null;
    },
    ImageCarousel_startTimer_closure: function ImageCarousel_startTimer_closure(t0) {
      this.$this = t0;
    },
    DirectionalBtn: function DirectionalBtn() {
    },
    DirectionalBtn_closure: function DirectionalBtn_closure(t0, t1) {
      this.carousel = t0;
      this.change = t1;
    },
  ...
  A.ImageCarousel.prototype = {
    startTimer$0() {
      var t1 = this.timer;
      if (t1 != null)
        t1.cancel$0();
      this.timer = A.Timer_Timer$periodic(new A.Duration(2000000), new A.ImageCarousel_startTimer_closure(this));
    },
    rotateBy$1(amount) {
      var imgs, t1, t2, t3, _this = this;
      _this.position += amount;
      imgs = document.getElementById("imgs");
      t1 = _this.position;
      t2 = _this.images._nodeList.length - 1;
      if (t1 > t2)
        t1 = _this.position = 0;
      else if (t1 < 0) {
        _this.position = t2;
      ...
      if (imgs != null) {
        t2 = imgs.style;
        t2.toString;
        t3 = B.CssStyleDeclaration_methods._browserPropertyName$1(t2, "transform");
        t2.setProperty(t3, "translateX(" + -t1 * 500 + "px)", "");
      }
      _this.startTimer$0();
    }
  };
  A.ImageCarousel_startTimer_closure.prototype = {
    call$1(timer) {
      this.$this.rotateBy$1(1);
    },
    $signature: 8
  };
  A.DirectionalBtn.prototype = {
    DirectionalBtn$3(carousel, element, change) {
      J._addEventListener$3$x(element, "click", type$.nullable_dynamic_Function_Event._as(new A.DirectionalBtn_closure(carousel, change)), null);
    }
  };
  A.DirectionalBtn_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.carousel.rotateBy$1(this.change);
    },
    $signature: 9
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncCallbackEntry, A._Zone, A.ListBase, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.ImageCarousel, A.DirectionalBtn]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.ImageCarousel_startTimer_closure, A.DirectionalBtn_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Null()", "~()", "~(~())", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "~(Timer)", "Null(Event)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_TimerImpl":{"Timer":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"Element":{"Node":[]},"HtmlElement":{"Element":[],"Node":[]},"AnchorElement":{"Element":[],"Node":[]},"AreaElement":{"Element":[],"Node":[]},"CharacterData":{"Node":[]},"_FrozenElementList":{"ElementList":["1"],"ListBase":["1"],"List":["1"],"Iterable":["1"],"ListBase.E":"1"},"FormElement":{"Element":[],"Node":[]},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[]}}'));
