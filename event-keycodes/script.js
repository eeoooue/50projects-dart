...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (insert != null) {
        t1 = window;
        t1.toString;
        B.Window_methods._addEventListener$3(t1, "keydown", type$.nullable_dynamic_Function_Event._as(new A.main_closure(insert)), null);
      }
    },
    createKeyDisplay(innerText, smallText) {
      var div = document.createElement("div"),
        t1 = J.getInterceptor$x(div);
      t1.get$classes(div).add$1(0, "key");
      t1.setInnerHtml$2$validator(div, innerText + "<small>" + smallText + "</small>", new A.AllowAll());
      return div;
    },
    getKeyString($event) {
      var t1 = $event.key;
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t1, keyName, t2, keyCode, eventCode;
      type$.Event._as($event);
      if (type$.KeyboardEvent._is($event)) {
        t1 = this.insert;
        keyName = A.createKeyDisplay(A.getKeyString($event), "event.key");
        t2 = $event.keyCode;
        t2.toString;
        keyCode = A.createKeyDisplay("" + t2, "event.keyCode");
        eventCode = A.createKeyDisplay(A.S($event.code), "event.code");
        t2 = J.getInterceptor$x(t1);
        t2.get$children(t1).clear$0(0);
        t2.get$children(t1).add$1(0, keyName);
        t2.get$children(t1).add$1(0, keyCode);
        t2.get$children(t1).add$1(0, eventCode);
      }
    },
    $signature: 12
  };
