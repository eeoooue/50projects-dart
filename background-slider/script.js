...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Slideshow$(left, right) {
      ...
      t1 = t1.querySelectorAll(".slide");
      t1.toString;
      t1 = new A.Slideshow(t2, new A._FrozenElementList(t1, type$._FrozenElementList_Element), left, right);
      t1.Slideshow$2(left, right);
      return t1;
    },
    main() {
      var t1 = document,
      ...
      if (t1._is(leftBtn) && t1._is(rightBtn))
        A.Slideshow$(leftBtn, rightBtn);
    },
    Slideshow: function Slideshow(t0, t1, t2, t3) {
      var _ = this;
      _.i = 0;
      _.body = t0;
      _.slides = t1;
    ...
    Slideshow_closure: function Slideshow_closure(t0) {
      this.$this = t0;
    },
    Slideshow_closure0: function Slideshow_closure0(t0) {
      this.$this = t0;
    },
  ...
  A.Slideshow.prototype = {
    Slideshow$2(left, right) {
      var _this = this;
      B.ButtonElement_methods.addEventListener$2(_this.left, "click", new A.Slideshow_closure(_this));
      B.ButtonElement_methods.addEventListener$2(_this.right, "click", new A.Slideshow_closure0(_this));
      _this.changeSlide$1(0);
    },
    changeSlide$1(amount) {
      var t4, _this = this,
        t1 = _this.slides,
        t2 = t1._nodeList,
        t3 = t2.length;
      _this.i = B.JSInt_methods.$mod(t3 + _this.i + amount, t3);
      ...
      t4 = t1.$ti._precomputed1._as(t2[t4]).style.backgroundImage;
      t4.toString;
      t3.backgroundImage = t4;
    },
    updateActiveSlide$0() {
      var t1, t2, t3, t4, t5;
      for (t1 = this.slides, t2 = t1.$ti, t3 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListBase.E>")), t4 = t2._eval$1("ListBase.E"); t3.moveNext$0();) {
        t5 = t3.__internal$_current;
        J.get$classes$x(t5 == null ? t4._as(t5) : t5).remove$1(0, "active");
      }
      t3 = this.i;
      t1 = t1._nodeList;
      if (!(t3 >= 0 && t3 < t1.length))
        return A.ioore(t1, t3);
      J.get$classes$x(t2._precomputed1._as(t1[t3])).add$1(0, "active");
    }
  };
  A.Slideshow_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.$this.changeSlide$1(-1);
    },
    $signature: 0
  };
  A.Slideshow_closure0.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.$this.changeSlide$1(1);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.Slideshow_closure, A.Slideshow_closure0]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BodyElement, A.ButtonElement, A.FormElement, A.SelectElement]);
