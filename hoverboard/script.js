...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (type$.Element._is(container)) {
        colours = J.JSArray_JSArray$growable(0, type$.String);
        B.JSArray_methods.add$1(colours, "#e74c3c");
        B.JSArray_methods.add$1(colours, "#8e44ad");
        B.JSArray_methods.add$1(colours, "#3498db");
        B.JSArray_methods.add$1(colours, "#e67e22");
        B.JSArray_methods.add$1(colours, "#2ecc71");
        new A.HoverboardGrid(container, colours, B.C__JSRandom).populate$0();
      }
    },
    HoverboardGrid: function HoverboardGrid(t0, t1, t2) {
      this.container = t0;
      this.colours = t1;
      this.randomizer = t2;
    },
    HoverboardGrid_createSquare_closure: function HoverboardGrid_createSquare_closure(t0, t1) {
      this.$this = t0;
      this.square = t1;
    },
    HoverboardGrid_createSquare_closure0: function HoverboardGrid_createSquare_closure0(t0, t1) {
      this.$this = t0;
      this.square = t1;
    },
  ...
  A.HoverboardGrid.prototype = {
    populate$0() {
      var t1, t2, i, square;
      for (t1 = this.container, t2 = J.getInterceptor$x(t1), i = 0; i < 500; ++i) {
        square = this.createSquare$0();
        t2.get$children(t1).add$1(0, square);
      }
    },
    createSquare$0() {
      var square = document.createElement("div"),
        t1 = J.getInterceptor$x(square);
      t1.get$classes(square).add$1(0, "square");
      t1.addEventListener$2(square, "mouseover", new A.HoverboardGrid_createSquare_closure(this, square));
      t1.addEventListener$2(square, "mouseout", new A.HoverboardGrid_createSquare_closure0(this, square));
      return square;
    }
  };
  A.HoverboardGrid_createSquare_closure.prototype = {
    call$1($event) {
      var t1, t2, t3, i, color;
      type$.Event._as($event);
      t1 = this.$this;
      t2 = this.square;
      t3 = t1.colours;
      i = t1.randomizer.nextInt$1(t3.length);
      if (!(i >= 0 && i < t3.length))
        return A.ioore(t3, i);
      color = t3[i];
      t3 = t2.style;
      ...
      t1 = t2.style;
      t1.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "box-shadow"), "0 0 2px " + color + ", 0 0 10px " + color, "");
    },
    $signature: 0
  };
  A.HoverboardGrid_createSquare_closure0.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.square;
      t2 = t1.style;
      t2.background = "#1d1d1d";
      t1 = t1.style;
      t1.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "box-shadow"), "0 0 2px #000", "");
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.HoverboardGrid_createSquare_closure, A.HoverboardGrid_createSquare_closure0]);
