...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t2, nums, replayBtn,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t2 = t1.querySelectorAll(".nums span");
      t2.toString;
      nums = new A._FrozenElementList(t2, type$._FrozenElementList_Element);
      A.runAnimation(nums);
      replayBtn = t1.querySelector("#replay");
      if (replayBtn != null)
        J.addEventListener$2$x(replayBtn, "click", new A.main_closure(nums));
    },
    resetState(nums) {
      var t2, t3, t4,
        t1 = document,
        counter = t1.querySelector(".counter"),
        finalMessage = t1.querySelector(".final");
      if (counter != null)
        J.get$classes$x(counter).remove$1(0, "hide");
      if (finalMessage != null)
        J.get$classes$x(finalMessage).remove$1(0, "show");
      for (t1 = nums.$ti, t2 = new A.ListIterator(nums, nums.get$length(nums), t1._eval$1("ListIterator<ListBase.E>")), t3 = t1._eval$1("ListBase.E"); t2.moveNext$0();) {
        t4 = t2.__internal$_current;
        J.get$classes$x(t4 == null ? t3._as(t4) : t4).clear$0(0);
      }
      t2 = nums._nodeList;
      if (0 >= t2.length)
        return A.ioore(t2, 0);
      J.get$classes$x(t1._precomputed1._as(t2[0])).add$1(0, "in");
    },
    runAnimation(nums) {
      var t1, t2, t3, i, num;
      for (t1 = nums._nodeList, t2 = nums.$ti._precomputed1, t3 = type$.nullable_dynamic_Function_Event, i = 0; i < t1.length; ++i) {
        num = t2._as(t1[i]);
        J._addEventListener$3$x(num, "animationend", t3._as(new A.runAnimation_closure(num, nums, i)), null);
      }
    },
    main_closure: function main_closure(t0) {
      this.nums = t0;
    },
    runAnimation_closure: function runAnimation_closure(t0, t1, t2) {
      this.num = t0;
      this.nums = t1;
      this.i = t2;
    },
  ...
  A.runAnimation_closure.prototype = {
    call$1(e) {
      var t1, t2, t3, counter, finalMessage;
      type$.Event._as(e);
      if (type$.AnimationEvent._is(e)) {
        t1 = this.num;
        t2 = this.nums._nodeList.length;
        t3 = document;
        counter = t3.querySelector(".counter");
        finalMessage = t3.querySelector(".final");
        t3 = e.animationName;
        if (t3 === "goIn" && this.i !== t2 - 1) {
          t2 = J.getInterceptor$x(t1);
          t2.get$classes(t1).remove$1(0, "in");
          t2.get$classes(t1).add$1(0, "out");
        } else if (t3 === "goOut" && t1.nextElementSibling != null) {
          t1 = t1.nextElementSibling;
          if (t1 != null)
            J.get$classes$x(t1).add$1(0, "in");
        } else {
          if (counter != null)
            J.get$classes$x(counter).add$1(0, "hide");
          if (finalMessage != null)
            J.get$classes$x(finalMessage).add$1(0, "show");
        }
      }
    },
    $signature: 0
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.Event, A.DomException, A.DomTokenList, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.CssClassSetImpl_clear_closure, A.main_closure, A.runAnimation_closure]);
    ...
    _inherit(A.AnimationEvent, A.Event);
