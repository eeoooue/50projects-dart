...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = window;
      t1.toString;
      B.Window_methods._addEventListener$3(t1, "scroll", type$.nullable_dynamic_Function_Event._as(new A.main_closure()), null);
      A.checkBoxes();
    },
    checkBoxes() {
      var triggerBottom, t2, t3, t4, t5,
        t1 = window.innerHeight;
      t1.toString;
      triggerBottom = t1 / 5 * 4;
      t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".box");
      t1.toString;
      ...
      for (; t1.moveNext$0();) {
        ...
        if (t3 == null)
          t3 = t2._as(t3);
        t4 = t3.getBoundingClientRect().top;
        t4.toString;
        t5 = J.getInterceptor$x(t3);
        if (t4 < triggerBottom)
          t5.get$classes(t3).add$1(0, "show");
        else
          t5.get$classes(t3).remove$1(0, "show");
      }
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.ListIterator, A.Closure, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomRectReadOnly, A.DomTokenList, A.Event, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.main_closure]);
