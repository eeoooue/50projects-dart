...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (container == null)
        return;
      dataStore = new A.DataStore(new A.ListQueue(A.List_List$filled(A.ListQueue__calculateCapacity(null), null, false, type$.nullable_Testimonial), type$.ListQueue_Testimonial));
      A.loadTestimonials(dataStore);
      A.Timer_Timer$periodic(new A.Duration(10000000), new A.main_closure(dataStore, new A.DisplayCard(container)));
    },
    loadTestimonials(dataStore) {
      var t1, t2, t3, _i,
        result = J.JSArray_JSArray$growable(0, type$.Testimonial);
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Jonathan Nunfiez", "https://randomuser.me/api/portraits/men/43.jpg", "Graphic Designer"), "I had my concerns that due to a tight deadline this project can't be done. But this guy proved me wrong not only he delivered an outstanding work but he managed to deliver 1 day prior to the deadline. And when I asked for some revisions he made them in MINUTES. I'm looking forward to work with him again and I totally recommend him. Thanks again!"));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Sasha Ho", "https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?h=350&auto=compress&cs=tinysrgb", "Accountant"), "This guy is a top notch designer and front end developer. He communicates well, works fast and produces quality work. We have been lucky to work with him!"));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Veeti Seppanen", "https://randomuser.me/api/portraits/men/97.jpg", "Director"), "This guy is a young and talented IT professional, proactive and responsible, with a strong work ethic. He is very strong in PSD2HTML conversions and HTML/CSS technology. He is a quick learner, eager to learn new technologies. He is focused and has the good dynamics to achieve due dates and outstanding results."));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("June Cha", "https://randomuser.me/api/portraits/women/44.jpg", "Software Engineer"), "This guy is an amazing frontend developer that delivered the task exactly how we need it, do your self a favor and hire him, you will not be disappointed by the work delivered. He will go the extra mile to make sure that you are happy with your project. I will surely work again with him!"));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Iida Niskanen", "https://randomuser.me/api/portraits/women/68.jpg", "Data Entry"), "This guy is a hard worker. Communication was also very good with him and he was very responsive all the time, something not easy to find in many freelancers. We'll definitely repeat with him."));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Renee Sims", "https://randomuser.me/api/portraits/women/65.jpg", "Receptionist"), "This guy does everything he can to get the job done and done right. This is the second time I've hired him, and I'll hire him again in the future."));
      B.JSArray_methods.add$1(result, new A.Testimonial(new A.Client("Miyah Myles", "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=707b9c33066bf8808c934c8ab394dff6", "Marketing"), "I've worked with literally hundreds of HTML/CSS developers and I have to say the top spot goes to this guy. This guy is an amazing developer. He stresses on good, clean code and pays heed to the details. I love developers who respect each and every aspect of a throughly thought out design and do their best to put it in code. He goes over and beyond and transforms ART into PIXELS - without a glitch, every time."));
      for (t1 = result.length, t2 = dataStore.testimonials, t3 = t2.$ti._precomputed1, _i = 0; _i < result.length; result.length === t1 || (0, A.throwConcurrentModificationError)(result), ++_i)
        t2._add$1(t3._as(result[_i]));
    },
    Testimonial: function Testimonial(t0, t1) {
      this.client = t0;
      this.text = t1;
    },
    Client: function Client(t0, t1, t2) {
      this.name = t0;
      this.photoAddress = t1;
      this.role = t2;
    },
    DisplayCard: function DisplayCard(t0) {
      this.container = t0;
    },
    DataStore: function DataStore(t0) {
      this.testimonials = t0;
    },
  ...
  A.Testimonial.prototype = {};
  A.Client.prototype = {};
  A.DisplayCard.prototype = {};
  A.DataStore.prototype = {
    getTestimonial$0() {
      var t2, t3, result,
        t1 = this.testimonials;
      if (t1.get$length(t1) === 0)
        return new A.Testimonial(new A.Client("name", "photoAddress", "role"), "text");
      t2 = t1._head;
      if (t2 === t1._tail)
      ...
      t1._add$1(t1.$ti._precomputed1._as(result));
      return result;
    }
  };
  A.main_closure.prototype = {
    call$1(timer) {
      var client, element, userImage,
        testimonial = this.dataStore.getTestimonial$0(),
        t1 = this.display.container,
        testimonial0 = t1.querySelector(".testimonial");
      if (testimonial0 != null)
        testimonial0.innerText = testimonial.text;
      client = testimonial.client;
      element = t1.querySelector(".username");
      if (element != null)
        element.innerText = client.name;
      element = t1.querySelector(".role");
      if (element != null)
        element.innerText = client.role;
      userImage = t1.querySelector(".user-image");
      if (type$.ImageElement._is(userImage))
        B.ImageElement_methods.set$src(userImage, client.photoAddress);
    },
    $signature: 8
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncCallbackEntry, A._Zone, A._ListQueueIterator, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A.StringBuffer, A.Testimonial, A.Client, A.DisplayCard, A.DataStore]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.main_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Null()", "~()", "~(~())", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "~(Timer)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_TimerImpl":{"Timer":[]},"ListQueue":{"ListIterable":["1"],"Queue":["1"],"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"HtmlElement":{"Element":[]},"AnchorElement":{"Element":[]},"AreaElement":{"Element":[]},"FormElement":{"Element":[]},"ImageElement":{"Element":[]},"SelectElement":{"Element":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ListQueue_Testimonial: findType("ListQueue<Testimonial>"),
      Null: findType("Null"),
      Object: findType("Object"),
      Record: findType("Record"),
      StackTrace: findType("StackTrace"),
      String: findType("String"),
      Testimonial: findType("Testimonial"),
      ...
      nullable_Testimonial: findType("Testimonial?"),
      num: findType("num"),
      void: findType("~"),
