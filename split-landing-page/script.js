...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (container != null) {
        left = t1.querySelector(".left");
        right = t1.querySelector(".right");
        t1 = new A.SensitiveContainer(container);
        if (left != null)
          t1.addListeners$2(left, "hover-left");
        if (right != null)
          t1.addListeners$2(right, "hover-right");
      }
    },
    SensitiveContainer: function SensitiveContainer(t0) {
      this.container = t0;
    },
    SensitiveContainer_addListeners_closure: function SensitiveContainer_addListeners_closure(t0, t1) {
      this.$this = t0;
      this.classname = t1;
    },
    SensitiveContainer_addListeners_closure0: function SensitiveContainer_addListeners_closure0(t0, t1) {
      this.$this = t0;
      this.classname = t1;
    },
  ...
  A.SensitiveContainer.prototype = {
    addListeners$2(element, classname) {
      var t1 = J.getInterceptor$x(element);
      t1.addEventListener$2(element, "mouseenter", new A.SensitiveContainer_addListeners_closure(this, classname));
      t1.addEventListener$2(element, "mouseleave", new A.SensitiveContainer_addListeners_closure0(this, classname));
    }
  };
  A.SensitiveContainer_addListeners_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      J.get$classes$x(this.$this.container).add$1(0, this.classname);
    },
    $signature: 0
  };
  A.SensitiveContainer_addListeners_closure0.prototype = {
    call$1($event) {
      type$.Event._as($event);
      J.get$classes$x(this.$this.container).remove$1(0, this.classname);
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.SensitiveContainer]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.SensitiveContainer_addListeners_closure, A.SensitiveContainer_addListeners_closure0]);
