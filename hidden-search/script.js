...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        search = t1.querySelector(".search"),
        btn = t1.querySelector(".btn"),
        input = t1.querySelector(".input");
      if (btn != null)
        J._addEventListener$3$x(btn, "click", type$.nullable_dynamic_Function_Event._as(new A.main_closure(search, input)), null);
    },
