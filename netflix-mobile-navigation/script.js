...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var nav,
        t1 = document,
        open_btn = t1.querySelector(".open-btn"),
        close_btn = t1.querySelector(".close-btn"),
        t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".nav");
      t1.toString;
      nav = new A._FrozenElementList(t1, type$._FrozenElementList_Element);
      if (open_btn != null)
        J.addEventListener$2$x(open_btn, "click", new A.main_closure(nav));
      if (close_btn != null)
        J.addEventListener$2$x(close_btn, "click", new A.main_closure0(nav));
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      for (t1 = this.nav, t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        J.get$classes$x(t3 == null ? t2._as(t3) : t3).add$1(0, "visible");
      }
    },
    $signature: 0
  };
  A.main_closure0.prototype = {
    call$1($event) {
      ...
      for (t1 = this.nav, t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        J.get$classes$x(t3 == null ? t2._as(t3) : t3).remove$1(0, "visible");
      }
    },
    $signature: 0
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.main_closure, A.main_closure0]);
