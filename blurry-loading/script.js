...
(function dartProgram() {
  ...
  A.BlurryLoader.prototype = {
    ...
    blurring$0() {
      ...
      t2 = t2.style;
      t2.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t2, B.CssStyleDeclaration_methods._browserPropertyName$1(t2, "opacity"), A.S(1 - t1 / 100), "");
      t1 = _this.load;
      t2 = _this.background.style;
      t2.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t2, B.CssStyleDeclaration_methods._browserPropertyName$1(t2, "filter"), "blur(" + A.S(30 - t1 / 100 * 30) + "px)", "");
    }
  };
