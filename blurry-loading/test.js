...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    BlurryLoader$(loadText, background) {
      var t1 = new A.BlurryLoader(background, loadText);
      t1.BlurryLoader$2(loadText, background);
      return t1;
    },
    main() {
      var t1 = document,
        loadText = t1.querySelector(".loading-text"),
        bg = t1.querySelector(".bg");
      if (loadText != null && bg != null) {
        A.print("hi!");
        A.BlurryLoader$(loadText, bg);
      }
    },
    BlurryLoader: function BlurryLoader(t0, t1) {
      this.load = 0;
      this.background = t0;
      this.loadText = t1;
    },
    BlurryLoader_closure: function BlurryLoader_closure(t0) {
      this.$this = t0;
    },
    printString(string) {
  ...
  A.BlurryLoader.prototype = {
    BlurryLoader$2(loadText, background) {
      A.Timer_Timer$periodic(new A.Duration(30000), new A.BlurryLoader_closure(this));
    },
    blurring$0() {
      var t2, _this = this,
        t1 = _this.load;
      if (t1 > 99)
        return;
      A.print("hii ii load=" + t1);
      t1 = _this.loadText;
      t1.innerText = "" + ++_this.load + "%";
      t2 = _this.load;
      t1 = t1.style;
      t1.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "opacity"), A.S(1 - t2 / 100), "");
      t2 = _this.load;
      t1 = _this.background.style;
      t1.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "filter"), "blur(" + A.S(30 - t2 / 100 * 30) + "px)", "");
    }
  };
  A.BlurryLoader_closure.prototype = {
    call$1(timer) {
      this.$this.blurring$0();
    },
    $signature: 8
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.BlurryLoader_closure]);
