...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (password != null)
        J._addEventListener$3$x(password, "input", type$.nullable_dynamic_Function_Event._as(new A.main_closure()), null);
    },
    ...
    call$1($event) {
      ...
      if (type$.TextInputElement._is(target)) {
        ...
        if (background != null) {
          t2 = background.style;
          t2.toString;
          t3 = B.CssStyleDeclaration_methods._browserPropertyName$1(t2, "filter");
          t2.setProperty(t3, "blur(" + (20 - t1.length * 2) + "px)", "");
        }
      }
    },
    $signature: 3
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._Exception, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A._DOMWindowCrossFrame]);
