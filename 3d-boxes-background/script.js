...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        boxesContainer = t1.getElementById("boxes"),
        btn = t1.getElementById("btn");
      if (btn != null)
        J._addEventListener$3$x(btn, "click", type$.nullable_dynamic_Function_Event._as(new A.main_closure(boxesContainer)), null);
      A.createBoxes();
    },
    createBoxes() {
      var t2, i, t3, j, box, t4,
        t1 = document,
        boxesContainer = t1.getElementById("boxes");
      for (t2 = boxesContainer == null, i = 0; i < 4; ++i)
        for (t3 = -i * 125, j = 0; j < 4; ++j) {
          box = t1.createElement("div");
          J.get$classes$x(box).add$1(0, "box");
          t4 = box.style;
          t4.backgroundPosition = "" + -j * 125 + "px " + t3 + "px";
          if (!t2)
            J.get$children$x(boxesContainer).add$1(0, box);
        }
    },
    main_closure: function main_closure(t0) {
      this.boxesContainer = t0;
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      t1 = this.boxesContainer;
      if (t1 != null)
        J.get$classes$x(t1).toggle$1(0, "big");
    },
    $signature: 6
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.main_closure]);
