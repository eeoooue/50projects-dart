...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var button = document.getElementById("button"),
        ...
        t2 = A._setArrayType(["Message One", "Message Two", "Message Three", "Message Four"], t1);
      t1 = A._setArrayType(["info", "success", "error"], t1);
      if (button != null)
        J._addEventListener$3$x(button, "click", type$.nullable_dynamic_Function_Event._as(new A.main_closure(new A.MessageDealer(B.C__JSRandom, t2, t1))), null);
    },
    displayToast(toast) {
      var container = document.getElementById("toasts");
      if (type$.Element._is(container)) {
        J.get$children$x(container).add$1(0, toast);
        A.Timer_Timer(new A.Duration(3000000), new A.displayToast_closure(toast));
      }
    },
    MessageDealer: function MessageDealer(t0, t1, t2) {
      this.randomizer = t0;
      this.messages = t1;
      this.types = t2;
    },
    ...
    displayToast_closure: function displayToast_closure(t0) {
      this.toast = t0;
    },
  ...
  A.MessageDealer.prototype = {};
  A.main_closure.prototype = {
    call$1($event) {
      var t1, t2, i, t3, message, type, notif;
      ...
      t1 = J.getInterceptor$x(notif);
      t1.get$classes(notif).add$1(0, "toast");
      t1.get$classes(notif).add$1(0, type);
      notif.innerText = message;
      A.displayToast(notif);
    },
    $signature: 11
  };
  A.displayToast_closure.prototype = {
    call$0() {
      J.remove$0$x(this.toast);
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.displayToast_closure]);
