...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    fixNav() {
      ...
      if (t2) {
        ...
        t1 = t1.document.documentElement.scrollTop;
        t1.toString;
        t1 = B.JSNumber_methods.round$0(t1);
      }
      t2 = nav.offsetHeight;
      t2.toString;
      t3 = J.getInterceptor$x(nav);
      if (t1 > B.JSNumber_methods.round$0(t2) + 150)
        t3.get$classes(nav).add$1(0, "active");
      else
        t3.get$classes(nav).remove$1(0, "active");
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator]);
