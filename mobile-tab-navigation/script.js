...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t2, t3, contents, i, item,
        _s16_ = "querySelectorAll",
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", _s16_);
      t3 = t1.querySelectorAll(".content");
      t3.toString;
      contents = new A._FrozenElementList(t3, type$._FrozenElementList_Element);
      A.checkTypeBound(t2, t2, "T", _s16_);
      t1 = t1.querySelectorAll("nav ul li");
      for (t3 = type$.nullable_dynamic_Function_Event, i = 0; i < t1.length; ++i) {
        item = t2._as(t1[i]);
        J._addEventListener$3$x(item, "click", t3._as(new A.main_closure(item, contents, i)), null);
      }
    },
    hideAllContents() {
      var t2, contents, t3,
      ...
      t1 = t1.querySelectorAll(".content");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      contents = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(contents, contents.get$length(contents), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        J.get$classes$x(t3 == null ? t2._as(t3) : t3).remove$1(0, "show");
      }
    },
    hideAllItems() {
      var t2, listItems, t3,
      ...
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      listItems = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(listItems, listItems.get$length(listItems), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1.__internal$_current;
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      A.hideAllContents();
      A.hideAllItems();
      J.get$classes$x(this.item).add$1(0, "active");
      t1 = this.contents;
      t2 = this.i;
      t3 = t1._nodeList;
      if (!(t2 < t3.length))
        return A.ioore(t3, t2);
      J.get$classes$x(t1.$ti._precomputed1._as(t3[t2])).add$1(0, "show");
    },
    $signature: 4
  };
  (function aliases() {
