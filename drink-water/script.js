...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelectorAll(".cup-small");
      for (t3 = type$.nullable_dynamic_Function_Event, i = 0; i < t1.length; ++i)
        J._addEventListener$3$x(t2._as(t1[i]), "click", t3._as(new A.main_closure(i)), null);
    },
    highlightCups(clickedIndex) {
      var t2, i, cup, t3, _s4_ = "full",
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".cup-small");
      if (!(clickedIndex < t1.length))
        return A.ioore(t1, clickedIndex);
      if (J.get$classes$x(t2._as(t1[clickedIndex])).contains$1(0, _s4_))
        --clickedIndex;
      for (i = 0; i < t1.length; ++i) {
        cup = t2._as(t1[i]);
        t3 = J.getInterceptor$x(cup);
        t3.get$classes(cup).remove$1(0, _s4_);
        if (i <= clickedIndex)
          t3.get$classes(cup).add$1(0, _s4_);
      }
      A.updateBigCup();
    },
    updateBigCup() {
      var t2, t3, liters, percentage, remained, fullCups, totalCups,
        _s16_ = "querySelectorAll",
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", _s16_);
      t3 = t1.querySelectorAll(".cup-small");
      t3.toString;
      liters = t1.getElementById("liters");
      percentage = t1.getElementById("percentage");
      remained = t1.getElementById("remained");
      A.checkTypeBound(t2, t2, "T", _s16_);
      fullCups = t1.querySelectorAll(".cup-small.full").length;
      totalCups = t3.length;
      if (fullCups === 0) {
        t1 = percentage == null;
        if (!t1) {
        ...
        if (!t1) {
          t2 = percentage.style;
          t2.height = A.S(fullCups / totalCups * 330) + "px";
        }
        if (!t1)
          percentage.innerText = A.S(fullCups / totalCups * 100) + "%";
      }
      if (fullCups === totalCups) {
        ...
        if (liters != null)
          liters.innerText = A.S(2 - 250 * fullCups / 1000) + "L";
      }
    },
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["@(@)", "@(@,String)", "@(String)", "bool(Set<String>)", "~(Event)"],
