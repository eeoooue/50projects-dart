...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      A.checkTypeBound(t2, type$.Element, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".code");
      codes = new A._FrozenElementList(t1, type$._FrozenElementList_TextInputElement);
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      t2._as(t1[0]).focus();
      for (t3 = type$.nullable_dynamic_Function_Event, i = 0; i < t1.length; ++i)
        B.InputElement_methods._addEventListener$3(t2._as(t1[i]), "keydown", t3._as(new A.main_closure(codes, i)), null);
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      if (type$.KeyboardEvent._is($event) && $event.key != null)
        if ($event.code === "Backspace")
          A.Timer_Timer(A.Duration$(10), new A.main__closure(_this.codes, _this.i));
        else {
          t1 = $event.keyCode;
          t1.toString;
          if (48 <= t1 && t1 <= 57) {
            ...
            J.set$value$x(t1.$ti._precomputed1._as(t3[t2]), "");
            A.Timer_Timer(A.Duration$(10), new A.main__closure0(t1, t2));
          }
        }
    },
    $signature: 8
  ...
  A.main__closure.prototype = {
    call$0() {
      ...
      if (!(t2 >= 0 && t2 < t3.length))
        return A.ioore(t3, t2);
      t1.$ti._precomputed1._as(t3[t2]).focus();
    },
    $signature: 0
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.Event, A._NodeList_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A.main_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A.initHooks_closure0, A.Closure2Args);
    _inherit(A._TypeError, A._Error);
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.main__closure, A.main__closure0]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "Null(Event)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"TextInputElement":{"Element":[],"Node":[]},"HtmlElement":{"Element":[],"Node":[]},"AnchorElement":{"Element":[],"Node":[]},"AreaElement":{"Element":[],"Node":[]},"CharacterData":{"Node":[]},"_FrozenElementList":{"ListBase":["1"],"List":["1"],"Iterable":["1"],"ListBase.E":"1"},"Element":{"Node":[]},"FormElement":{"Element":[],"Node":[]},"InputElement":{"TextInputElement":[],"Element":[],"Node":[]},"KeyboardEvent":{"Event":[]},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[]},"UIEvent":{"Event":[]}}'));
  var type$ = (function rtii() {
    ...
    return {
      ...
      _FrozenElementList_TextInputElement: findType("_FrozenElementList<TextInputElement>"),
      bool: findType("bool"),
