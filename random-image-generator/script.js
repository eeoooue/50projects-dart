...
(function dartProgram() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["@(@)", "@(@,String)", "@(String)", "bool(Node)", "Element(Node)"],
