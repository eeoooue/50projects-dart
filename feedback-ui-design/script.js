...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    FeedbackPanel$(container, sendBtn) {
      var t1 = J.JSArray_JSArray$growable(0, type$.FeedbackOption);
      t1 = new A.FeedbackPanel(t1, sendBtn);
      t1.FeedbackPanel$2(container, sendBtn);
      return t1;
    },
    FeedbackOption$($parent, element, imageElement, small) {
      var t1 = new A.FeedbackOption($parent, element, small);
      t1.FeedbackOption$4($parent, element, imageElement, small);
      return t1;
    },
    main() {
      var t1 = document,
        container = t1.querySelector(".ratings-container"),
        sendBtn = t1.querySelector("#send");
      t1 = type$.Element;
      if (t1._is(container) && t1._is(sendBtn))
        A.FeedbackPanel$(container, sendBtn);
    },
    AllowAll: function AllowAll() {
    },
    FeedbackPanel: function FeedbackPanel(t0, t1) {
      this.selectedRating = "Satisfied";
      this.options = t0;
      this.sendBtn = t1;
    },
    FeedbackPanel_closure: function FeedbackPanel_closure(t0) {
      this.$this = t0;
    },
    FeedbackOption: function FeedbackOption(t0, t1, t2) {
      this.parent = t0;
      this.element = t1;
      this.small = t2;
    },
    FeedbackOption_closure: function FeedbackOption_closure(t0) {
      this.$this = t0;
    },
  ...
  A.FeedbackPanel.prototype = {
    FeedbackPanel$2(container, sendBtn) {
      var t2, t3, ratings, t4, t5, sibling, small, _this = this,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".rating");
      t1.toString;
      t3 = type$._FrozenElementList_Element;
      ratings = new A._FrozenElementList(t1, t3);
      for (t1 = new A.ListIterator(ratings, ratings.get$length(ratings), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E"), t4 = _this.options; t1.moveNext$0();) {
        t5 = t1.__internal$_current;
        if (t5 == null)
          t5 = t3._as(t5);
        sibling = t5.querySelector("img");
        small = t5.querySelector("small");
        if (t2._is(sibling) && t2._is(small))
          B.JSArray_methods.add$1(t4, A.FeedbackOption$(_this, t5, sibling, small));
      }
      J.addEventListener$2$x(_this.sendBtn, "click", new A.FeedbackPanel_closure(_this));
    },
    deactivateOptions$0() {
      var t1, t2, _i;
      for (t1 = this.options, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        J.get$classes$x(t1[_i].element).remove$1(0, "active");
    }
  };
  A.FeedbackPanel_closure.prototype = {
    call$1($event) {
      var panel, t1;
      type$.Event._as($event);
      panel = document.querySelector("#panel");
      t1 = "" + "<i class='fas fa-heart'></i><strong>Thank You!</strong><br>" + ("<strong>Feedback: " + this.$this.selectedRating + "</strong><p>") + "We'll use your feedback to improve our customer support</p>";
      if (panel != null)
        J.setInnerHtml$2$validator$x(panel, t1.charCodeAt(0) == 0 ? t1 : t1, new A.AllowAll());
      return null;
    },
    $signature: 2
  };
  A.FeedbackOption.prototype = {
    FeedbackOption$4($parent, element, imageElement, small) {
      J.addEventListener$2$x(this.element, "click", new A.FeedbackOption_closure(this));
    }
  };
  A.FeedbackOption_closure.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.$this;
      t2 = t1.parent;
      t2.deactivateOptions$0();
      J.get$classes$x(t1.element).add$1(0, "active");
      t1 = t1.small.innerText;
      t1.toString;
      t2.selectedRating = t1;
      return null;
    },
    $signature: 2
  };
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["bool(NodeValidator)", "bool(String)", "~(Event)", "bool(Element,String,String,_Html5NodeValidator)", "@(@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "bool(Node)", "String(String)", "~(Node,Node?)", "bool(Set<String>)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      FeedbackOption: findType("FeedbackOption"),
