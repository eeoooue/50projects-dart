...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (t2._is(fill)) {
        t1 = J.getInterceptor$x(fill);
        t1.addEventListener$2(fill, "dragstart", new A.main_closure(fill));
        t1.addEventListener$2(fill, "dragend", new A.main_closure0(fill));
      }
    },
