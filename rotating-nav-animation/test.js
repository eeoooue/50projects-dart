...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        openBtn = t1.getElementById("open"),
        closeBtn = t1.getElementById("close"),
        container = t1.querySelector(".container");
      if (openBtn != null && closeBtn != null && container != null) {
        t1 = new A.RotatingNav(openBtn, closeBtn, container);
        t1.setupOpenBtn$0();
        t1.setupCloseBtn$0();
      }
    },
    RotatingNav: function RotatingNav(t0, t1, t2) {
      this.openBtn = t0;
      this.closeBtn = t1;
      this.container = t2;
    },
    RotatingNav_setupOpenBtn_closure: function RotatingNav_setupOpenBtn_closure(t0) {
      this.$this = t0;
    },
    RotatingNav_setupCloseBtn_closure: function RotatingNav_setupCloseBtn_closure(t0) {
      this.$this = t0;
    },
  ...
  A.RotatingNav.prototype = {
    setupOpenBtn$0() {
      J.addEventListener$2$x(this.openBtn, "click", new A.RotatingNav_setupOpenBtn_closure(this));
    },
    setupCloseBtn$0() {
      J.addEventListener$2$x(this.closeBtn, "click", new A.RotatingNav_setupCloseBtn_closure(this));
    }
  };
  A.RotatingNav_setupOpenBtn_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      J.get$classes$x(this.$this.container).add$1(0, "show-nav");
    },
    $signature: 0
  };
  A.RotatingNav_setupCloseBtn_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      J.get$classes$x(this.$this.container).remove$1(0, "show-nav");
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.RotatingNav_setupOpenBtn_closure, A.RotatingNav_setupCloseBtn_closure]);
