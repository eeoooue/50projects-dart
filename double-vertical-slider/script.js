...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DoubleSlider$(slideLeft, slideRight, up, down) {
      var t1 = new A.DoubleSlider(slideLeft, slideRight, up, down);
      t1.DoubleSlider$4(slideLeft, slideRight, up, down);
      return t1;
    },
    main() {
      var t1 = document,
        slideLeft = t1.querySelector(".left-slide"),
        slideRight = t1.querySelector(".right-slide"),
        upButton = t1.querySelector(".up-button"),
        downButton = t1.querySelector(".down-button");
      t1 = type$.Element;
      if (t1._is(slideLeft) && t1._is(slideRight)) {
        t1 = type$.ButtonElement;
        if (t1._is(upButton) && t1._is(downButton))
          A.DoubleSlider$(slideLeft, slideRight, upButton, downButton);
      }
    },
    DoubleSlider: function DoubleSlider(t0, t1, t2, t3) {
      var _ = this;
      _.slideLeft = t0;
      _.slideRight = t1;
      _.up = t2;
      _.down = t3;
      _.slideCount = _.activeSlide = 0;
    },
    DoubleSlider_closure: function DoubleSlider_closure(t0) {
      this.$this = t0;
    },
    DoubleSlider_closure0: function DoubleSlider_closure0(t0) {
      this.$this = t0;
    },
  ...
  A.DoubleSlider.prototype = {
    DoubleSlider$4(slideLeft, slideRight, up, down) {
      var t2, _this = this,
        t1 = type$.Element;
      A.checkTypeBound(t1, t1, "T", "querySelectorAll");
      t1 = _this.slideRight.querySelectorAll("div").length;
      _this.slideCount = t1;
      t2 = _this.slideLeft.style;
      t2.top = "-" + (t1 - 1) * 100 + "vh";
      B.ButtonElement_methods.addEventListener$2(_this.up, "click", new A.DoubleSlider_closure(_this));
      B.ButtonElement_methods.addEventListener$2(_this.down, "click", new A.DoubleSlider_closure0(_this));
    },
    changeSlide$1(direction) {
      var t1, t2, t3, _this = this,
        _s9_ = "transform",
        sliderContainer = document.querySelector(".slider-container");
      if (sliderContainer == null)
        return;
      t1 = sliderContainer.clientHeight;
      t1.toString;
      t2 = _this.activeSlide;
      if (direction === "up")
        t2 = _this.activeSlide = B.JSInt_methods.$mod(t2 + 1, _this.slideCount);
      else {
        t2 = _this.activeSlide = t2 - 1;
        if (t2 < 0) {
          t2 = _this.slideCount - 1;
          _this.activeSlide = t2;
        }
      }
      t3 = _this.slideRight.style;
      t3.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t3, B.CssStyleDeclaration_methods._browserPropertyName$1(t3, _s9_), "translateY(-" + t2 * t1 + "px)", "");
      t2 = _this.slideLeft.style;
      t2.toString;
      t3 = _this.activeSlide;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t2, B.CssStyleDeclaration_methods._browserPropertyName$1(t2, _s9_), "translateY(" + t3 * t1 + "px)", "");
    }
  };
  A.DoubleSlider_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.$this.changeSlide$1("up");
    },
    $signature: 0
  };
  A.DoubleSlider_closure0.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.$this.changeSlide$1("down");
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.Closure, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._Exception, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.DoubleSlider]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event, A._NodeList_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.DoubleSlider_closure, A.DoubleSlider_closure0]);
  ...
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"Closure":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"String":{"Pattern":[]},"Element":{"Node":[]},"HtmlElement":{"Element":[],"Node":[]},"AnchorElement":{"Element":[],"Node":[]},"AreaElement":{"Element":[],"Node":[]},"ButtonElement":{"Element":[],"Node":[]},"CharacterData":{"Node":[]},"FormElement":{"Element":[],"Node":[]},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[]}}'));
