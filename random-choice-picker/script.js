...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    RandomChoicePicker$(textArea, tagContainer) {
      var t1 = J.JSArray_JSArray$growable(0, type$.ChoiceTag);
      t1 = new A.RandomChoicePicker(tagContainer, textArea, B.C__JSRandom, t1);
      t1.RandomChoicePicker$2(textArea, tagContainer);
      return t1;
    },
    main() {
      var t1 = document,
        tagsEl = t1.getElementById("tags"),
        textarea = t1.getElementById("textarea");
      if (type$.TextAreaElement._is(textarea) && type$.Element._is(tagsEl))
        A.RandomChoicePicker$(textarea, tagsEl);
    },
    RandomChoicePicker: function RandomChoicePicker(t0, t1, t2, t3) {
      var _ = this;
      _.tagContainer = t0;
      _.textArea = t1;
      _.randomizer = t2;
    ...
    RandomChoicePicker_closure: function RandomChoicePicker_closure(t0) {
      this.$this = t0;
    },
    RandomChoicePicker_iterate_closure: function RandomChoicePicker_iterate_closure(t0, t1) {
      this.$this = t0;
      this.i = t1;
    },
    ChoiceTag: function ChoiceTag(t0) {
      this.__ChoiceTag_element_A = $;
      this.text = t0;
    },
  ...
  A.RandomChoicePicker.prototype = {
    RandomChoicePicker$2(textArea, tagContainer) {
      var t1 = this.textArea;
      t1.focus();
      B.TextAreaElement_methods._addEventListener$3(t1, "keyup", type$.nullable_dynamic_Function_Event._as(new A.RandomChoicePicker_closure(this)), null);
    },
    refreshContainer$0() {
      var t3, t4, _i, tag, t5, t6,
        t1 = this.tagContainer,
        t2 = J.getInterceptor$x(t1);
      t2.get$children(t1).clear$0(0);
      for (t3 = this.choices, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, A.throwConcurrentModificationError)(t3), ++_i) {
        tag = t3[_i];
        t5 = t2.get$children(t1);
        t6 = tag.__ChoiceTag_element_A;
    ...
    createTags$1(text) {
      ...
      for (t2 = text.split(","), t3 = t2.length, _i = 0; _i < t3; ++_i) {
        text = J.trim$0$s(t2[_i]);
        if (text.length > 0) {
          tag = new A.ChoiceTag(text);
          t4 = document.createElement("span");
          tag.__ChoiceTag_element_A = t4;
          J.get$classes$x(t4).add$1(0, "tag");
          t4.innerText = text;
          B.JSArray_methods.add$1(t1, tag);
        }
      }
      this.refreshContainer$0();
    },
    deactivateAll$0() {
      var t1, t2, _i, t3;
      for (t1 = this.choices, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        t3 = t1[_i].__ChoiceTag_element_A;
        t3 === $ && A.throwLateFieldNI("element");
        J.get$classes$x(t3).remove$1(0, "highlight");
      }
    },
    iterate$1(i) {
      var t1, _this = this;
      if (i === _this.limit)
        return;
      _this.deactivateAll$0();
      t1 = _this.choices;
      t1 = t1[B.JSInt_methods.$mod(i, t1.length)].__ChoiceTag_element_A;
      t1 === $ && A.throwLateFieldNI("element");
      J.get$classes$x(t1).add$1(0, "highlight");
      A.Timer_Timer(new A.Duration(100000), new A.RandomChoicePicker_iterate_closure(_this, i));
    }
  };
  A.RandomChoicePicker_closure.prototype = {
    call$1($event) {
      var t1, t2, n;
      type$.Event._as($event);
      t1 = this.$this;
      t2 = t1.textArea.value;
      t2.toString;
      t1.createTags$1(t2);
      if (type$.KeyboardEvent._is($event))
        if ($event.key === "Enter") {
          n = t1.choices.length;
          t1.limit = n * 3 + t1.randomizer.nextInt$1(n);
          t1.iterate$1(0);
        }
    },
    $signature: 11
  };
  A.RandomChoicePicker_iterate_closure.prototype = {
    call$0() {
      this.$this.iterate$1(this.i + 1);
    },
    $signature: 0
  };
  A.ChoiceTag.prototype = {};
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.SelectElement, A.TextAreaElement]);
