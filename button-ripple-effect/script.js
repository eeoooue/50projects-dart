...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t2, buttons, t3, t4,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".ripple");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      buttons = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(buttons, buttons.get$length(buttons), t2._eval$1("ListIterator<ListBase.E>")), t3 = type$.nullable_dynamic_Function_Event, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t4 = t1._current;
        if (t4 == null)
          t4 = t2._as(t4);
        J._addEventListener$3$x(t4, "click", t3._as(new A.main_closure(t4)), null);
      }
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      if (type$.MouseEvent._is($event)) {
        ...
        J.get$classes$x(circle).add$1(0, "circle");
        t1 = circle.style;
        t1.toString;
        ...
        t1.left = A.S(t2.x) + "px";
        J.get$children$x(this.button).add$1(0, circle);
        A.Timer_Timer(new A.Duration(500000), new A.main__closure(circle));
      }
    },
    $signature: 11
  };
