...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    TodoList$(form, input, container) {
      var t1 = J.JSArray_JSArray$growable(0, type$.TodoTask);
      t1 = new A.TodoList(form, input, container, new A.StorageSystem(), t1);
      t1.TodoList$3(form, input, container);
      return t1;
    },
    TodoTask$($parent, text, completed) {
      var t1 = new A.TodoTask($parent, text, completed);
      t1.TodoTask$3($parent, text, completed);
      return t1;
    },
    main() {
      var t1 = document,
        form = t1.getElementById("form"),
        input = t1.getElementById("input"),
        todosUL = t1.getElementById("todos");
      if (type$.FormElement._is(form) && type$.TextInputElement._is(input))
        if (type$.Element._is(todosUL))
          A.TodoList$(form, input, todosUL);
    },
    StorageSystem: function StorageSystem() {
    },
    TodoList: function TodoList(t0, t1, t2, t3, t4) {
      var _ = this;
      _.form = t0;
      _.input = t1;
      _.container = t2;
    ...
    TodoList_closure: function TodoList_closure(t0) {
      this.$this = t0;
    },
    TodoTask: function TodoTask(t0, t1, t2) {
      var _ = this;
      _.parent = t0;
      _.text = t1;
      _.__TodoTask_element_A = $;
      _.completed = t2;
    },
    TodoTask_closure: function TodoTask_closure(t0) {
      this.$this = t0;
    },
    TodoTask_closure0: function TodoTask_closure0(t0) {
      this.$this = t0;
    },
  ...
  A.StorageSystem.prototype = {
    getList$0() {
      var t1,
        data = window.localStorage.getItem("todolist");
      if (typeof data == "string")
        return this.decodeString$1(data);
      t1 = J.JSArray_JSArray$growable(0, type$.String);
      return t1;
    },
    encodeStrings$1(strings) {
      var t1, _i, t2;
    ...
    decodeString$1(encoded) {
      var t1, t2, _i, s,
        result = J.JSArray_JSArray$growable(0, type$.String);
      for (t1 = encoded.split(","), t2 = t1.length, _i = 0; _i < t2; ++_i) {
        s = t1[_i];
        if (J.get$length$asx(s) > 0)
          B.JSArray_methods.add$1(result, s);
      }
      return result;
    }
  };
  A.TodoList.prototype = {
    TodoList$3(form, input, container) {
      this.initialize$0();
      B.FormElement_methods.addEventListener$2(this.form, "submit", new A.TodoList_closure(this));
    },
    initialize$0() {
      var t1, t2, t3, t4, _i, taskData, t5, task, t6, _this = this,
        tasks = _this.storage.getList$0();
      for (t1 = tasks.length, t2 = _this.tasks, t3 = _this.container, t4 = J.getInterceptor$x(t3), _i = 0; _i < tasks.length; tasks.length === t1 || (0, A.throwConcurrentModificationError)(tasks), ++_i) {
        taskData = tasks[_i];
        if (1 >= taskData.length)
          return A.ioore(taskData, 1);
        t5 = taskData[1];
        task = A.TodoTask$(_this, B.JSString_methods.substring$1(taskData, 3), t5 === "x");
        B.JSArray_methods.add$1(t2, task);
        t5 = t4.get$children(t3);
        t6 = task.__TodoTask_element_A;
    ...
    appendTask$1(task) {
      var t1, t2;
      B.JSArray_methods.add$1(this.tasks, task);
      t1 = J.get$children$x(this.container);
      t2 = task.__TodoTask_element_A;
      t2 === $ && A.throwLateFieldNI("element");
      t1.add$1(0, t2);
    },
    update$0(_) {
      var t1, t2, _i, task, data,
        list = J.JSArray_JSArray$growable(0, type$.String);
      for (t1 = this.tasks, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        task = t1[_i];
        B.JSArray_methods.add$1(list, "[" + (task.completed ? "x" : "o") + "]" + task.text);
      }
      data = this.storage.encodeStrings$1(type$.List_String._as(list));
      window.localStorage.setItem("todolist", data);
    }
  };
  A.TodoList_closure.prototype = {
    call$1($event) {
      var t1, t2, text;
      ...
      if (typeof text == "string") {
        t1.appendTask$1(A.TodoTask$(t1, text, false));
        t1.update$0(0);
      }
  ...
  A.TodoTask.prototype = {
    TodoTask$3($parent, text, completed) {
      var _this = this,
        li = document.createElement("li"),
        t1 = J.getInterceptor$x(li);
      t1.get$classes(li).add$1(0, "todo");
      li.innerText = _this.text;
      if (_this.completed)
        t1.get$classes(li).add$1(0, "completed");
      _this.__TodoTask_element_A = li;
      J.addEventListener$2$x(li, "click", new A.TodoTask_closure(_this));
      J.addEventListener$2$x(_this.__TodoTask_element_A, "contextmenu", new A.TodoTask_closure0(_this));
    }
  };
  A.TodoTask_closure.prototype = {
    call$1($event) {
      var t1, t2,
        _s9_ = "completed";
      type$.Event._as($event);
      t1 = this.$this;
      t2 = t1.__TodoTask_element_A;
      t2 === $ && A.throwLateFieldNI("element");
      J.get$classes$x(t2).toggle$1(0, _s9_);
      t1.completed = J.get$classes$x(t1.__TodoTask_element_A).contains$1(0, _s9_);
      t1.parent.update$0(0);
      return null;
    },
    $signature: 9
  };
  A.TodoTask_closure0.prototype = {
    call$1($event) {
      var t1, t2, t3;
      type$.Event._as($event).preventDefault();
      t1 = this.$this;
      t2 = t1.parent;
      t3 = t1.__TodoTask_element_A;
      t3 === $ && A.throwLateFieldNI("element");
      J.remove$0$ax(t3);
      B.JSArray_methods.remove$1(t2.tasks, t1);
      t2.update$0(0);
    },
    $signature: 0
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.Iterable, A.MappedIterator, A.WhereIterator, A.Closure, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.MapBase, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.StorageSystem, A.TodoList, A.TodoTask]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.TodoList_closure, A.TodoTask_closure, A.TodoTask_closure0]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A.Storage_keys_closure]);
