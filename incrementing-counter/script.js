...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelectorAll(".counter");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      counters = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(counters, counters.get$length(counters), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1._current;
        new A.IncrementingCounter(t3 == null ? t2._as(t3) : t3).incrementCounter$0();
      }
    },
    IncrementingCounter: function IncrementingCounter(t0) {
      this.element = t0;
      this.value = 0;
    },
    IncrementingCounter_incrementCounter_closure: function IncrementingCounter_incrementCounter_closure(t0) {
      this.$this = t0;
    },
  ...
  A.IncrementingCounter.prototype = {
    getTarget$0() {
      var target = this.element.getAttribute("data-target");
      if (typeof target == "string")
        return A.int_parse(target);
      return 0;
    },
    incrementCounter$0() {
      var _this = this,
        target = _this.getTarget$0(),
        t1 = _this.value += B.JSInt_methods._tdivFast$1(target, 200);
      if (t1 > target) {
        _this.value = target;
        t1 = target;
      }
      _this.element.innerText = B.JSInt_methods.toString$0(t1);
      if (_this.value !== target)
        A.Timer_Timer(new A.Duration(1000), new A.IncrementingCounter_incrementCounter_closure(_this));
    }
  };
  A.IncrementingCounter_incrementCounter_closure.prototype = {
    call$0() {
      this.$this.incrementCounter$0();
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncCallbackEntry, A._Zone, A.ListBase, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.IncrementingCounter]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A.initHooks_closure0, A.Closure2Args);
    _inherit(A._TypeError, A._Error);
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.IncrementingCounter_incrementCounter_closure]);
