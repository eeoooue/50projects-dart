...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    checkCheckboxOfClass(classname) {
      ...
      if (type$.CheckboxInputElement._is(element))
        return element.checked === true;
      return false;
    },
    generatePassword($length) {
      var i, t1, t2, t3, result, i0, letter,
        _s9_ = "lowercase",
        _s9_0 = "uppercase",
        _s26_ = "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
        _s20_ = "!@#$%^&*(){}[]=<>/,.",
        _s26_0 = "abcdefghijklmnopqrstuvwxyz",
        queue = new A.ListQueue(A.List_List$filled(A.ListQueue__calculateCapacity(null), null, false, type$.nullable_String), type$.ListQueue_String);
      if (A.checkCheckboxOfClass(_s9_))
        queue._add$1(_s9_);
      if (A.checkCheckboxOfClass(_s9_0))
        queue._add$1(_s9_0);
      if (A.checkCheckboxOfClass("numbers"))
        queue._add$1("digit");
      if (A.checkCheckboxOfClass("symbols"))
        queue._add$1("special");
      if (queue.get$length(queue) === 0)
        return "";
      for (i = 0, t1 = ""; i < $length; ++i) {
        ...
        result = t3[t2];
        if (result == null)
          result = A._asString(result);
        B.JSArray_methods.$indexSet(t3, t2, null);
        queue._head = (queue._head + 1 & queue._table.length - 1) >>> 0;
        queue._add$1(result);
        switch (result) {
          case "uppercase":
            i0 = B.C__JSRandom.nextInt$1(26);
            if (!(i0 >= 0 && i0 < 26))
              return A.ioore(_s26_, i0);
            letter = _s26_[i0];
            break;
          case "digit":
            i0 = B.C__JSRandom.nextInt$1(10);
            if (!(i0 >= 0 && i0 < 10))
              return A.ioore("1234567890", i0);
            letter = "1234567890"[i0];
            break;
          case "special":
            i0 = B.C__JSRandom.nextInt$1(20);
            if (!(i0 >= 0 && i0 < 20))
              return A.ioore(_s20_, i0);
            letter = _s20_[i0];
            break;
          default:
            i0 = B.C__JSRandom.nextInt$1(26);
            if (!(i0 >= 0 && i0 < 26))
              return A.ioore(_s26_0, i0);
            letter = _s26_0[i0];
        }
        t1 += letter;
      }
    ...
    RandomHelper: function RandomHelper(t0) {
      this.random = t0;
    },
  ...
  A.InputElement.prototype = {$isNumberInputElement: 1, $isCheckboxInputElement: 1};
  A.Node.prototype = {
    toString$0(receiver) {
  ...
  A.RandomHelper.prototype = {};
  A.main_closure.prototype = {
    call$1($event) {
      var t1, pass;
      type$.Event._as($event);
      t1 = this.lengthEl;
      if (type$.NumberInputElement._is(t1) && t1.value != null) {
        t1 = t1.value;
        t1.toString;
        pass = A.generatePassword(A.int_parse(t1));
        t1 = this.resultEl;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._ListQueueIterator, A._Exception, A.FormatException, A.Null, A.StringBuffer, A._JSRandom, A.RandomHelper]);
