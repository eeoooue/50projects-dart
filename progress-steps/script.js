...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = new A.ProgressPath();
      t1.__ProgressPath_prevBtn_A = A.PrevButton$(t1);
      t1.__ProgressPath_nextBtn_A = A.NextButton$(t1);
    },
    ProgressPath: function ProgressPath() {
  ...
  A.ProgressPath.prototype = {
    ...
    update$0() {
      ...
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t2 = t1.querySelectorAll(".circle");
      t2.toString;
      t3 = type$._FrozenElementList_Element;
      circles = new A._FrozenElementList(t2, t3);
      for (t2 = new A.ListIterator(circles, circles.get$length(circles), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E"), i = 1; t2.moveNext$0();) {
        t4 = t2.__internal$_current;
        if (t4 == null)
          t4 = t3._as(t4);
        t5 = J.getInterceptor$x(t4);
        t5.get$classes(t4).remove$1(0, "active");
        if (i <= _this.currentActive)
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.CssClassSetImpl_add_closure, A.PrevButton_closure, A.NextButton_closure]);
