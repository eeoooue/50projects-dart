...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = type$.Element;
      if (t1._is(main)) {
        t2 = J.JSArray_JSArray$growable(0, type$.MovieCard);
        app = new A.MovieApp(main, t2);
        app.getMovies$1("https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=3fd2be6f0c70a2a598f084ddfb75487c&page=1");
        if (t1._is(form) && type$.TextInputElement._is(search))
          A.SearchWidget$(app, form, search);
      }
    },
    AllowAll: function AllowAll() {
    },
    MovieApp: function MovieApp(t0, t1) {
      this.element = t0;
      this.cards = t1;
    },
    MovieCard: function MovieCard(t0, t1, t2, t3) {
      var _ = this;
      _.title = t0;
      _.posterPath = t1;
      _.score = t2;
      _.overview = t3;
      _.__MovieCard_element_A = $;
    },
  ...
  A.MovieApp.prototype = {
    getMovies$1(url) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, movie, t3, title, posterPath, score, overview, card, card0, t4, results, t1, $async$temp1, $async$temp2, $async$temp3;
      var $async$getMovies$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString(url), $async$getMovies$1);
            case 2:
              ...
              for (t2 = J.get$iterator$ax(results); t2.moveNext$0();) {
                ...
                t3.get$classes(card0).add$1(0, "movie");
                t4 = "" + ('<img src="https://image.tmdb.org/t/p/w1280' + posterPath + '" alt="' + title + '">') + '<div class="movie-info">' + ("<h3>" + title + "</h3>") + ('<span class="' + card.deriveScoreClass$0() + '">' + A.S(score) + "</span>") + '</div><div class="overview"><h3>Overview</h3>' + overview + "</div>";
                t3.setInnerHtml$2$validator(card0, t4.charCodeAt(0) == 0 ? t4 : t4, new A.AllowAll());
                card.__MovieCard_element_A = card0;
                B.JSArray_methods.add$1(t1, card);
              }
              $async$self.showMovies$0();
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$getMovies$1, $async$completer);
    },
    showMovies$0() {
      var t3, t4, _i, card, t5, t6,
        t1 = this.element,
      ...
      for (t3 = this.cards, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, A.throwConcurrentModificationError)(t3), ++_i) {
        ...
        t6 = card.__MovieCard_element_A;
        t6 === $ && A.throwLateFieldNI("element");
        t5.add$1(0, t6);
      }
    }
  };
  A.MovieCard.prototype = {
    deriveScoreClass$0() {
      var t1 = this.score;
      if (t1 >= 8)
        return "green";
  ...
  A.SearchWidget.prototype = {
    ...
    searchMovies$1(searchTerm) {
      if (searchTerm.length < 1) {
        type$.Location._as(window.location).reload();
        return;
      }
      this.parent.getMovies$1('https://api.themoviedb.org/3/search/movie?api_key=3fd2be6f0c70a2a598f084ddfb75487c&query="' + searchTerm);
    }
  };
  A.SearchWidget_closure.prototype = {
    call$1($event) {
      ...
      t1 = this.$this;
      searchTerm = t1.textInput.value;
      if (typeof searchTerm == "string")
        t1.searchMovies$1(searchTerm);
    },
    $signature: 26
  };
  (function aliases() {
