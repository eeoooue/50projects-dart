...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    SoundButton$($parent, soundName) {
      var t1 = document.createElement("button");
      t1 = new A.SoundButton(t1, soundName, $parent);
      t1.SoundButton$2($parent, soundName);
      return t1;
    },
    main() {
      var t1,
      ...
      if (container != null) {
        t1 = A._setArrayType(new Array(0), type$.JSArray_SoundButton);
        new A.SoundBoard(container, t1).SoundBoard$1(container);
      }
    },
    SoundBoard: function SoundBoard(t0, t1) {
      this.container = t0;
      this.buttons = t1;
    },
    SoundButton: function SoundButton(t0, t1, t2) {
      this.element = t0;
      this.soundName = t1;
      this.parent = t2;
    },
    SoundButton_closure: function SoundButton_closure(t0) {
      this.$this = t0;
    },
  ...
  A.SoundBoard.prototype = {
    SoundBoard$1(container) {
      var t1, t2, _i, button,
        soundNames = ["applause", "boo", "gasp", "tada", "victory", "wrong"];
      for (t1 = this.buttons, t2 = this.container, _i = 0; _i < 6; ++_i) {
        button = A.SoundButton$(this, soundNames[_i]);
        B.JSArray_methods.add$1(t1, button);
        t2.appendChild(button.element).toString;
      }
    },
    muteAll$0() {
      var t1, t2, t3, _i, button, element;
      for (t1 = this.buttons, t2 = t1.length, t3 = type$.AudioElement, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        button = t1[_i];
        element = document.getElementById(button.soundName);
        if (t3._is(element)) {
          element.pause();
  ...
  A.SoundButton.prototype = {
    SoundButton$2($parent, soundName) {
      var t1 = this.element,
        t2 = J.getInterceptor$x(t1);
      t2.get$classes(t1).add$1(0, "btn");
      t1.innerText = this.soundName;
      t2._addEventListener$3(t1, "click", type$.nullable_dynamic_Function_Event._as(new A.SoundButton_closure(this)), null);
    }
  };
  A.SoundButton_closure.prototype = {
    call$1($event) {
      var t1, element;
      type$.Event._as($event);
      t1 = this.$this;
      t1.parent.muteAll$0();
      element = document.getElementById(t1.soundName);
      if (type$.AudioElement._is(element)) {
        t1 = element.play();
        t1.toString;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.NullRejectionException, A.SoundBoard, A.SoundButton]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomTokenList, A.Event, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.MediaElement, A.FormElement, A.SelectElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_SoundButton: findType("JSArray<SoundButton>"),
