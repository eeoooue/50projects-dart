...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    QuizManager$(container, questions, submitBtn) {
      var t1 = J.JSArray_JSArray$growable(0, type$.OptionWidget);
      t1 = new A.QuizManager(t1, questions, container, submitBtn);
      t1.QuizManager$3(container, questions, submitBtn);
      return t1;
    },
    main() {
      var q2o, q3o, q4o, submitBtn,
        t1 = document,
        quiz = t1.getElementById("quiz"),
        questions = J.JSArray_JSArray$growable(0, type$.Question),
        t2 = type$.JSArray_String,
        q1o = A._setArrayType(["Java", "C", "Python", "JavaScript"], t2),
        t3 = type$.String;
      J.JSArray_JSArray$growable(0, t3);
      B.JSArray_methods.add$1(questions, new A.Question("Which language runs in a web browser?", q1o, 3));
      q2o = A._setArrayType(["Central Style Sheets", "Cascading Style Sheets", "Cascading Simple Sheets", "Cars SUVs Sailboats"], t2);
      J.JSArray_JSArray$growable(0, t3);
      B.JSArray_methods.add$1(questions, new A.Question("What does CSS stand for?", q2o, 1));
      q3o = A._setArrayType(["Hypertext Markup Language", "Hypertext Markdown Language", "Hyperloop Machine Language", "Helicopters Terminals Motorboats Lamborginis"], t2);
      J.JSArray_JSArray$growable(0, t3);
      B.JSArray_methods.add$1(questions, new A.Question("What does HTML stand for?", q3o, 0));
      q4o = A._setArrayType(["1996", "1995", "1994", "none of the above"], t2);
      J.JSArray_JSArray$growable(0, t3);
      B.JSArray_methods.add$1(questions, new A.Question("What year was JavaScript launched?", q4o, 1));
      submitBtn = t1.getElementById("submit");
      if (type$.Element._is(quiz) && type$.ButtonElement._is(submitBtn))
        A.QuizManager$(quiz, questions, submitBtn);
    },
    AllowAll: function AllowAll() {
    },
    Question: function Question(t0, t1, t2) {
      this.question = t0;
      this.options = t1;
      this.answerIndex = t2;
    },
    QuizManager: function QuizManager(t0, t1, t2, t3) {
      var _ = this;
      _.optionWidgets = t0;
      _.questions = t1;
      _.score = _.currentQuestion = 0;
      _.container = t2;
      _.submitBtn = t3;
    },
    QuizManager_closure: function QuizManager_closure(t0) {
      this.$this = t0;
    },
    OptionWidget: function OptionWidget(t0, t1) {
      this.element = t0;
      this.label = t1;
    },
  ...
  A.QuizManager.prototype = {
    QuizManager$3(container, questions, submitBtn) {
      var t1, t2, _this = this;
      _this.makeWidgets$0();
      t1 = _this.questions;
      t2 = _this.currentQuestion;
      if (!(t2 < t1.length))
        return A.ioore(t1, t2);
      _this.LoadQuestion$1(t1[t2]);
      B.ButtonElement_methods._addEventListener$3(_this.submitBtn, "click", type$.nullable_dynamic_Function_Event._as(new A.QuizManager_closure(_this)), null);
    },
    makeWidgets$0() {
      var t2, t3, n, t4, t5, t6, i, element, label,
        _s16_ = "querySelectorAll",
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", _s16_);
      t3 = t1.querySelectorAll(".answer");
      t3.toString;
      A.checkTypeBound(t2, t2, "T", _s16_);
      t1 = t1.querySelectorAll(".question-holder");
      n = Math.min(t3.length, t1.length);
      for (t4 = type$.CheckboxInputElement, t5 = type$.LabelElement, t6 = this.optionWidgets, i = 0; i < n; ++i) {
        if (!(i < t3.length))
          return A.ioore(t3, i);
        element = t2._as(t3[i]);
        if (!(i < t1.length))
          return A.ioore(t1, i);
        label = t2._as(t1[i]);
        if (t4._is(element) && t5._is(label))
          B.JSArray_methods.add$1(t6, new A.OptionWidget(element, label));
      }
    },
    getSelectedIndex$0() {
      var t1, t2, i;
      for (t1 = this.optionWidgets, t2 = t1.length, i = 0; i < t2; ++i)
        if (t1[i].element.checked === true)
          return i;
      return -1;
    },
    LoadQuestion$1(question) {
      var t1, t2, n, i, t3, t4,
        questionEl = document.getElementById("question");
      if (type$.Element._is(questionEl))
        questionEl.innerText = question.question;
      t1 = question.options;
      t2 = this.optionWidgets;
      n = Math.min(t1.length, t2.length);
      for (i = 0; i < n; ++i) {
        if (!(i < t2.length))
          return A.ioore(t2, i);
        t3 = t2[i];
        if (!(i < t1.length))
          return A.ioore(t1, i);
        t4 = t1[i];
        B.InputElement_methods.set$checked(t3.element, false);
        B.LabelElement_methods.set$text(t3.label, t4);
      }
    }
  };
  A.QuizManager_closure.prototype = {
    call$1($event) {
      var t1, t2, t3, t4;
      type$.Event._as($event);
      t1 = this.$this;
      t2 = t1.questions;
      t3 = t1.currentQuestion;
      if (!(t3 < t2.length))
        return A.ioore(t2, t3);
      if (t2[t3].answerIndex === t1.getSelectedIndex$0())
        ++t1.score;
      t3 = ++t1.currentQuestion;
      t4 = t2.length;
      if (t3 < t4)
        t1.LoadQuestion$1(t2[t3]);
      else {
        t2 = "" + ("<h2>You answered " + t1.score + "/" + t4 + " questions correctly</h2>") + '<button onclick="location.reload()">Reload</button>';
        J.setInnerHtml$2$validator$x(t1.container, t2.charCodeAt(0) == 0 ? t2 : t2, new A.AllowAll());
      }
      return null;
    },
    $signature: 10
  };
  A.OptionWidget.prototype = {};
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.StackOverflowError, A._Exception, A.Null, A.StringBuffer, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A.AllowAll, A.Question, A.QuizManager, A.OptionWidget]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.ButtonElement, A.FormElement, A.InputElement, A.LabelElement, A.SelectElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      OptionWidget: findType("OptionWidget"),
