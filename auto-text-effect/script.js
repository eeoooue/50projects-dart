...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    TextEffect$(textEl, speedEl) {
      var t1 = new A.TextEffect(textEl, speedEl, A.Duration$(300));
      t1.TextEffect$2(textEl, speedEl);
      return t1;
    },
    main() {
      var t1 = document,
        textEl = t1.getElementById("text"),
        speedEl = t1.getElementById("speed");
      if (type$.HeadingElement._is(textEl) && type$.InputElement._is(speedEl))
        A.TextEffect$(textEl, speedEl);
    },
    TextEffect: function TextEffect(t0, t1, t2) {
      var _ = this;
      _.textEl = t0;
      _.speedEl = t1;
      _.writeRate = t2;
    ...
    TextEffect_closure: function TextEffect_closure(t0) {
      this.$this = t0;
    },
    TextEffect_resetTimer_closure: function TextEffect_resetTimer_closure(t0) {
      this.$this = t0;
    },
  ...
  A.InputElement.prototype = {$isInputElement: 1, $isTextInputElement: 1};
  A.Node.prototype = {
    toString$0(receiver) {
  ...
  A.TextEffect.prototype = {
    TextEffect$2(textEl, speedEl) {
      this.resetTimer$0();
      B.InputElement_methods._addEventListener$3(this.speedEl, "input", type$.nullable_dynamic_Function_Event._as(new A.TextEffect_closure(this)), null);
    },
    resetTimer$0() {
      var _this = this,
        t1 = _this.timer;
      if (t1 != null)
        t1.cancel$0();
      _this.timer = A.Timer_Timer$periodic(_this.writeRate, new A.TextEffect_resetTimer_closure(_this));
    },
    getSlice$1(position) {
      var i, t1,
        _s20_ = "We Love Programming!";
      for (i = 0, t1 = ""; i < position; ++i) {
        if (!(i < 20))
          return A.ioore(_s20_, i);
        t1 += _s20_[i];
      }
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    }
  };
  A.TextEffect_closure.prototype = {
    call$1($event) {
      var value, n, t1,
        target = J.get$target$x(type$.Event._as($event));
      if (type$.TextInputElement._is(target)) {
        value = target.value;
        if (typeof value == "string") {
          n = A.Primitives_parseInt(value, null);
          if (n != null) {
            t1 = this.$this;
            t1.writeRate = A.Duration$(B.JSInt_methods.$tdiv(300, n));
            t1.resetTimer$0();
          }
        }
      }
  ...
  A.TextEffect_resetTimer_closure.prototype = {
    call$1(timer) {
      var t1 = this.$this;
      t1.textEl.innerText = t1.getSlice$1(t1.position);
      if (++t1.position > 20)
        t1.position = 1;
    },
    $signature: 9
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncCallbackEntry, A._Zone, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A.StringBuffer, A._DOMWindowCrossFrame, A.TextEffect]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.TextEffect_closure, A.TextEffect_resetTimer_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.HeadingElement, A.InputElement, A.SelectElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Null()", "~()", "~(~())", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "Null(Event)", "~(Timer)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","OpenDBRequest":"EventTarget","Request":"EventTarget","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_TimerImpl":{"Timer":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"HtmlElement":{"EventTarget":[]},"AnchorElement":{"EventTarget":[]},"AreaElement":{"EventTarget":[]},"CharacterData":{"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"EventTarget":[]},"HeadingElement":{"EventTarget":[]},"InputElement":{"TextInputElement":[],"EventTarget":[]},"Node":{"EventTarget":[]},"SelectElement":{"EventTarget":[]},"Window":{"WindowBase":[],"EventTarget":[]},"_DOMWindowCrossFrame":{"WindowBase":[],"EventTarget":[]},"VersionChangeEvent":{"Event":[]}}'));
