...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelectorAll(".form-control label");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      labels = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(labels, labels.get$length(labels), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t3 = t1._current;
        A.armWaveAnimation(t3 == null ? t2._as(t3) : t3);
      }
    },
    armWaveAnimation(label) {
      var t1, t2, i, t3;
      for (t1 = label.innerText, t2 = t1.length, i = 0, t3 = ""; i < t2; ++i)
        t3 += '<span style="transition-delay:' + i * 50 + 'ms">' + t1[i] + "</span>";
      J.setInnerHtml$2$validator$x(label, t3.charCodeAt(0) == 0 ? t3 : t3, new A.AllowAll());
    },
