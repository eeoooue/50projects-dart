...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    OptionWidget$(manager, element) {
      var t1 = new A.OptionWidget(element);
      t1.OptionWidget$2(manager, element);
      return t1;
    },
    main() {
      new A.OptionManager(new A.ListQueue(A.List_List$filled(A.ListQueue__calculateCapacity(null), null, false, type$.nullable_OptionWidget), type$.ListQueue_OptionWidget)).OptionManager$0();
    },
    OptionManager: function OptionManager(t0) {
      this.active = this.limit = 0;
      this.queue = t0;
    },
    OptionWidget: function OptionWidget(t0) {
      this.element = t0;
    },
    OptionWidget_closure: function OptionWidget_closure(t0, t1) {
      this.$this = t0;
      this.manager = t1;
    },
  ...
  A.OptionManager.prototype = {
    OptionManager$0() {
      var t2, toggles, t3, t4,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".toggle");
      t2 = type$._FrozenElementList_Element;
      toggles = new A._FrozenElementList(t1, t2);
      this.limit = t1.length;
      for (t1 = new A.ListIterator(toggles, toggles.get$length(toggles), t2._eval$1("ListIterator<ListBase.E>")), t3 = type$.CheckboxInputElement, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t4 = t1._current;
        if (t4 == null)
          t4 = t2._as(t4);
        if (t3._is(t4))
          A.OptionWidget$(this, t4);
      }
    },
    deactivateOldest$0() {
      var t3, result,
      ...
      t1 = result.element;
      if (t1.checked === true) {
        B.InputElement_methods.set$checked(t1, false);
        --this.active;
        return;
      }
      this.deactivateOldest$0();
    }
  };
  A.OptionWidget.prototype = {
    OptionWidget$2(manager, element) {
      B.InputElement_methods._addEventListener$3(this.element, "change", type$.nullable_dynamic_Function_Event._as(new A.OptionWidget_closure(this, manager)), null);
    }
  };
  A.OptionWidget_closure.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5, newTable, split;
      type$.Event._as($event);
      t1 = this.manager;
      t2 = this.$this;
      t3 = t1.queue;
      if (t2.element.checked === true) {
        ++t1.active;
        t4 = t3.$ti;
        t4._precomputed1._as(t2);
        B.JSArray_methods.$indexSet(t3._table, t3._tail, t2);
        t2 = t3._tail;
        t5 = t3._table.length;
        t2 = (t2 + 1 & t5 - 1) >>> 0;
        t3._tail = t2;
        if (t3._head === t2) {
          newTable = A.List_List$filled(t5 * 2, null, false, t4._eval$1("1?"));
          t2 = t3._table;
          t4 = t3._head;
          split = t2.length - t4;
          B.JSArray_methods.setRange$4(newTable, 0, split, t2, t4);
          B.JSArray_methods.setRange$4(newTable, split, split + t3._head, t3._table, 0);
          t3._head = 0;
          t3._tail = t3._table.length;
          t3.set$_table(newTable);
        }
        ++t3._modificationCount;
        if (t1.active >= t1.limit)
          t1.deactivateOldest$0();
      } else {
        t3.remove$1(0, t2);
        --t1.active;
      }
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.Closure, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._ListQueueIterator, A._Exception, A.Null, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.OptionManager, A.OptionWidget]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.OptionWidget_closure]);
  ...
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"Closure":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"ListQueue":{"ListIterable":["1"],"Queue":["1"],"Iterable":["1"]},"Element":{"Node":[]},"HtmlElement":{"Element":[],"Node":[]},"AnchorElement":{"Element":[],"Node":[]},"AreaElement":{"Element":[],"Node":[]},"CharacterData":{"Node":[]},"_FrozenElementList":{"ListBase":["1"],"List":["1"],"Iterable":["1"],"ListBase.E":"1"},"FormElement":{"Element":[],"Node":[]},"InputElement":{"CheckboxInputElement":[],"Element":[],"Node":[]},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ListQueue_OptionWidget: findType("ListQueue<OptionWidget>"),
      Null: findType("Null"),
      ...
      nullable_OptionWidget: findType("OptionWidget?"),
