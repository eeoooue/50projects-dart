...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Notebook$(addBtn) {
      var t1 = J.JSArray_JSArray$growable(0, type$.NoteElement);
      t1 = new A.Notebook(addBtn, t1);
      t1.Notebook$1(addBtn);
      return t1;
    },
    NoteEditBtn$($parent, element) {
      var t1 = new A.NoteEditBtn($parent, element);
      t1.NoteEditBtn$2($parent, element);
      return t1;
    },
    NoteDelBtn$($parent, element) {
      var t1 = new A.NoteDelBtn($parent, element);
      t1.NoteDelBtn$2($parent, element);
      return t1;
    },
    main() {
      var addBtn = document.getElementById("add");
      if (type$.ButtonElement._is(addBtn))
        A.Notebook$(addBtn);
    },
    AllowAll: function AllowAll() {
    },
    Notebook: function Notebook(t0, t1) {
      this.addBtn = t0;
      this.notes = t1;
    },
    Notebook_closure: function Notebook_closure(t0) {
      this.$this = t0;
    },
    NoteElement: function NoteElement(t0, t1, t2) {
      this.parent = t0;
      this.element = t1;
      this.text = t2;
    },
    NoteElement_setupElement_closure: function NoteElement_setupElement_closure(t0, t1) {
      this.$this = t0;
      this.textArea = t1;
    },
    NoteEditBtn: function NoteEditBtn(t0, t1) {
      this.parent = t0;
      this.element = t1;
    },
    NoteEditBtn_closure: function NoteEditBtn_closure(t0) {
      this.$this = t0;
    },
    NoteDelBtn: function NoteDelBtn(t0, t1) {
      this.parent = t0;
      this.element = t1;
    },
    NoteDelBtn_closure: function NoteDelBtn_closure(t0) {
      this.$this = t0;
    },
  ...
  A.Element.prototype = {
    ...
    createFragment$3$treeSanitizer$validator(receiver, html, treeSanitizer, validator) {
      ...
      if (treeSanitizer == null) {
        ...
        throw A.wrapException(A.ArgumentError$("validator can only be passed if treeSanitizer is null"));
  ...
  A.Notebook.prototype = {
    Notebook$1(addBtn) {
      this.initialize$0();
      B.ButtonElement_methods.addEventListener$2(this.addBtn, "click", new A.Notebook_closure(this));
    },
    initialize$0() {
      var noteStrings, t1, t2, _i, text, t3, note, _this = this,
        data = window.localStorage.getItem("notebook");
      if (typeof data == "string") {
        noteStrings = _this.unpackStrings$1(data);
        for (t1 = noteStrings.length, t2 = _this.notes, _i = 0; _i < noteStrings.length; noteStrings.length === t1 || (0, A.throwConcurrentModificationError)(noteStrings), ++_i) {
          text = noteStrings[_i];
          t3 = document.createElement("div");
          note = new A.NoteElement(_this, t3, text);
          note.NoteElement$2(_this, text);
          B.JSArray_methods.add$1(t2, note);
          _this.update$0(0);
        }
      }
    },
    unpackStrings$1(list) {
      var t1, t2, _i, note,
        result = J.JSArray_JSArray$growable(0, type$.String);
      for (t1 = list.split(","), t2 = t1.length, _i = 0; _i < t2; ++_i) {
        note = t1[_i];
        if (J.get$length$asx(note) > 1)
          B.JSArray_methods.add$1(result, note);
      }
      return result;
    },
    update$0(_) {
      var t1, t2, _i, data,
        noteStrings = J.JSArray_JSArray$growable(0, type$.String);
      for (t1 = this.notes, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        B.JSArray_methods.add$1(noteStrings, t1[_i].text);
      data = this.encodeList$1(noteStrings);
      window.localStorage.setItem("notebook", data);
    },
    encodeList$1(strings) {
      var t1, _i, t2;
      type$.List_String._as(strings);
      for (t1 = strings.length, _i = 0, t2 = ""; _i < t1; ++_i)
        t2 = t2 + strings[_i] + ",";
    ...
    createNote$1(text) {
      var textArea,
        ...
        note = new A.NoteElement(this, t2, text);
      J.get$classes$x(t2).add$1(0, "note");
      note.setupElement$0();
      t1 = t1.body;
      if (t1 != null) {
      ...
      if (note.text.length === 0) {
        textArea = t2.querySelector("textarea");
        if (type$.TextAreaElement._is(textArea))
          textArea.focus();
      }
      B.JSArray_methods.add$1(this.notes, note);
      this.update$0(0);
    }
  };
  A.Notebook_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      return this.$this.createNote$1("");
    },
    $signature: 13
  };
  A.NoteElement.prototype = {
    NoteElement$2($parent, text) {
      var t2, textArea,
        t1 = this.element;
      J.get$classes$x(t1).add$1(0, "note");
      this.setupElement$0();
      t2 = document.body;
      if (t2 != null) {
    ...
    updateText$0() {
      var textArea, _this = this,
        t1 = _this.element,
        main = t1.querySelector(".main");
      if (type$.Element._is(main))
        main.innerText = _this.text;
      textArea = t1.querySelector("textarea");
      if (type$.TextInputElement._is(textArea))
        B.InputElement_methods.set$value(textArea, _this.text);
      _this.parent.update$0(0);
    },
    toggleEditable$0() {
      var t1 = this.element,
        main = t1.querySelector(".main"),
        textArea = t1.querySelector("textarea");
      t1 = type$.Element;
      if (t1._is(main) && t1._is(textArea)) {
        J.get$classes$x(main).toggle$1(0, "hidden");
        J.get$classes$x(textArea).toggle$1(0, "hidden");
      }
    },
    setupElement$0() {
      var editBtn, deleteBtn, textArea, _this = this,
        t1 = "" + '<div class="tools"><button class="edit"><i class="fas fa-edit"></i></button><button class="delete"><i class="fas fa-trash-alt"></i></button></div><div class="main hidden"></div><textarea></textarea>',
        t2 = _this.element;
      J.setInnerHtml$2$validator$x(t2, t1.charCodeAt(0) == 0 ? t1 : t1, new A.AllowAll());
      if (_this.text.length > 0)
        _this.toggleEditable$0();
      editBtn = t2.querySelector(".edit");
      t1 = type$.ButtonElement;
      if (t1._is(editBtn))
        A.NoteEditBtn$(_this, editBtn);
      deleteBtn = t2.querySelector(".delete");
      if (t1._is(deleteBtn))
        A.NoteDelBtn$(_this, deleteBtn);
      textArea = t2.querySelector("textarea");
      if (type$.TextAreaElement._is(textArea)) {
        B.TextAreaElement_methods.set$value(textArea, _this.text);
        B.TextAreaElement_methods.addEventListener$2(textArea, "input", new A.NoteElement_setupElement_closure(_this, textArea));
      }
      _this.updateText$0();
    }
  };
  A.NoteElement_setupElement_closure.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.$this;
      t2 = this.textArea.value;
      t2.toString;
      t1.text = t2;
      t1.updateText$0();
    },
  ...
  A.NoteEditBtn.prototype = {
    NoteEditBtn$2($parent, element) {
      B.ButtonElement_methods.addEventListener$2(this.element, "click", new A.NoteEditBtn_closure(this));
    }
  };
  A.NoteEditBtn_closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      this.$this.parent.toggleEditable$0();
    },
    $signature: 0
  };
  A.NoteDelBtn.prototype = {
    NoteDelBtn$2($parent, element) {
      B.ButtonElement_methods.addEventListener$2(this.element, "click", new A.NoteDelBtn_closure(this));
    }
  };
  A.NoteDelBtn_closure.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.$this.parent;
      J.remove$0$ax(t1.element);
      t2 = t1.parent;
      B.JSArray_methods.remove$1(t2.notes, t1);
      t2.update$0(0);
    },
    $signature: 0
  };
  ...
  (function installTearOffs() {
    ...
    _static(A, "html__Html5NodeValidator__standardAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__standardAttributeValidator"], 3, 0);
    _static(A, "html__Html5NodeValidator__uriAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__uriAttributeValidator"], 3, 0);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A.StringBuffer, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A.AllowAll, A.Notebook, A.NoteElement, A.NoteEditBtn, A.NoteDelBtn]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      NoteElement: findType("NoteElement"),
      Null: findType("Null"),
