...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelectorAll(".faq-toggle");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      toggles = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(toggles, toggles.get$length(toggles), t2._eval$1("ListIterator<ListBase.E>")), t3 = type$.nullable_dynamic_Function_Event, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        t4 = t1._current;
        if (t4 == null)
          t4 = t2._as(t4);
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      $parent = this.toggle.parentNode;
      if (type$.Element._is($parent))
        J.get$classes$x($parent).toggle$1(0, "active");
    },
    $signature: 3
  };
  (function aliases() {
