...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t2 = t1.querySelectorAll(".screen");
      t2.toString;
      startButton = t1.getElementById("start-btn");
      if (type$.ButtonElement._is(startButton))
        B.ButtonElement_methods.addEventListener$2(startButton, "click", new A.main_closure(new A._FrozenElementList(t2, type$._FrozenElementList_Element)));
    },
    getInsectChoice(screens) {
      var t2, choices, t3, t4, t5,
        t1 = document;
      t1.toString;
      t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(".choose-insect-btn");
      t1.toString;
      t2 = type$._FrozenElementList_Element;
      choices = new A._FrozenElementList(t1, t2);
      for (t1 = new A.ListIterator(choices, choices.get$length(choices), t2._eval$1("ListIterator<ListBase.E>")), t3 = type$.ButtonElement, t2 = t2._eval$1("ListBase.E"), t4 = type$.nullable_dynamic_Function_Event; t1.moveNext$0();) {
        t5 = t1.__internal$_current;
        if (t5 == null)
          t5 = t2._as(t5);
        if (t3._is(t5))
          B.ButtonElement_methods._addEventListener$3(t5, "click", t4._as(new A.getInsectChoice_closure(t5, screens)), null);
      }
    },
    AllowAll: function AllowAll() {
    },
    InsectGame: function InsectGame(t0, t1) {
      var _ = this;
      _.container = t0;
      _.enemyInfo = t1;
      _.score = 0;
    ...
    InsectGame_startGame_closure: function InsectGame_startGame_closure(t0) {
      this.$this = t0;
    },
    InsectGame_spawnInsect_closure: function InsectGame_spawnInsect_closure(t0, t1) {
      this.$this = t0;
      this.insect = t1;
    },
    InsectGame_spawnInsect__closure: function InsectGame_spawnInsect__closure(t0) {
      this.insect = t0;
    },
    InsectGame_addInsects_closure: function InsectGame_addInsects_closure(t0) {
      this.$this = t0;
    },
    InsectGame_addInsects_closure0: function InsectGame_addInsects_closure0(t0) {
      this.$this = t0;
    },
    InsectInfo: function InsectInfo(t0, t1, t2) {
      this.src = t0;
      this.alt = t1;
      this.randomizer = t2;
    },
    ...
    getInsectChoice_closure: function getInsectChoice_closure(t0, t1) {
      this.choice = t0;
      this.screens = t1;
    },
  ...
  A.InsectGame.prototype = {
    startGame$0() {
      this.spawnInsect$0();
      A.Timer_Timer$periodic(A.Duration$(0, 1), new A.InsectGame_startGame_closure(this));
    },
    formatTime$1(time) {
      if (time < 10)
        return "0" + time;
      return B.JSInt_methods.toString$0(time);
    },
    spawnInsect$0() {
      var t3, t4, t5,
        t1 = this.enemyInfo,
        insect = document.createElement("div"),
        t2 = J.getInterceptor$x(insect);
      t2.get$classes(insect).add$1(0, "insect");
      t3 = insect.style;
      t3.toString;
      t4 = window.innerHeight;
      t4.toString;
      t5 = t1.randomizer;
      t4 = t5.nextInt$1(t4 - 200);
      t3.top = "" + (t4 + 100) + "px";
      t3 = insect.style;
      t3.toString;
      ...
      t4 = t5.nextInt$1(t4 - 200);
      t3.left = "" + (t4 + 100) + "px";
      t2.setInnerHtml$2$validator(insect, '<img src="' + t1.src + '" alt="' + t1.alt + '" style="transform: rotate(' + t5.nextInt$1(360) + 'deg)" />', new A.AllowAll());
      t2.addEventListener$2(insect, "click", new A.InsectGame_spawnInsect_closure(this, insect));
      J.get$children$x(this.container).add$1(0, insect);
    },
    addInsects$0() {
      A.Timer_Timer(A.Duration$(1000, 0), new A.InsectGame_addInsects_closure(this));
      A.Timer_Timer(A.Duration$(1500, 0), new A.InsectGame_addInsects_closure0(this));
    }
  };
  A.InsectGame_startGame_closure.prototype = {
    call$1(timer) {
      var t1 = this.$this,
        t2 = ++t1.seconds,
        mins = B.JSInt_methods._tdivFast$1(t2, 60),
        secs = B.JSInt_methods.$mod(t2, 60),
        timeEl = document.getElementById("time");
      if (type$.Element._is(timeEl))
        timeEl.innerText = "Time: " + t1.formatTime$1(mins) + ":" + t1.formatTime$1(secs);
    },
    $signature: 18
  };
  A.InsectGame_spawnInsect_closure.prototype = {
    call$1($event) {
      var t1, message, scoreEl, t2;
      type$.Event._as($event);
      t1 = this.$this;
      if (++t1.score >= 20) {
        message = document.getElementById("message");
        if (type$.Element._is(message))
          J.get$classes$x(message).add$1(0, "visible");
      }
      scoreEl = document.getElementById("score");
      if (type$.Element._is(scoreEl))
        scoreEl.innerText = "Score: " + t1.score;
      t2 = this.insect;
      J.get$classes$x(t2).add$1(0, "caught");
      t1.addInsects$0();
      A.Timer_Timer(A.Duration$(0, 2), new A.InsectGame_spawnInsect__closure(t2));
    },
    $signature: 2
  };
  A.InsectGame_spawnInsect__closure.prototype = {
    call$0() {
      J.remove$0$x(this.insect);
    },
    $signature: 0
  };
  A.InsectGame_addInsects_closure.prototype = {
    call$0() {
      this.$this.spawnInsect$0();
    },
    $signature: 0
  };
  A.InsectGame_addInsects_closure0.prototype = {
    call$0() {
      this.$this.spawnInsect$0();
    },
    $signature: 0
  };
  A.InsectInfo.prototype = {};
  A.main_closure.prototype = {
    call$1($event) {
      ...
      if (0 >= t2.length)
        return A.ioore(t2, 0);
      J.get$classes$x(t1.$ti._precomputed1._as(t2[0])).add$1(0, "up");
      A.getInsectChoice(t1);
    },
    $signature: 2
  };
  A.getInsectChoice_closure.prototype = {
    call$1($event) {
      var img, t1, t2, container;
      type$.Event._as($event);
      img = this.choice.querySelector("img");
      if (type$.ImageElement._is(img)) {
        t1 = this.screens;
        t2 = t1._nodeList;
        if (1 >= t2.length)
          return A.ioore(t2, 1);
        J.get$classes$x(t1.$ti._precomputed1._as(t2[1])).add$1(0, "up");
        t2 = img.getAttribute("alt");
        t2.toString;
        t1 = img.getAttribute("src");
        t1.toString;
        container = document.getElementById("game-container");
        if (type$.Element._is(container))
          new A.InsectGame(container, new A.InsectInfo(t1, t2, B.C__JSRandom)).startGame$0();
      }
    },
    $signature: 2
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncCallbackEntry, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A._JSRandom, A.AllowAll, A.InsectGame, A.InsectInfo]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.Element_Element$html_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.InsectGame_startGame_closure, A.InsectGame_spawnInsect_closure, A.main_closure, A.getInsectChoice_closure]);
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.InsectGame_spawnInsect__closure, A.InsectGame_addInsects_closure, A.InsectGame_addInsects_closure0]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.ButtonElement, A.FormElement, A.ImageElement, A.SelectElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement]);
