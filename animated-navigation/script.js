...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        toggle = t1.getElementById("toggle"),
        nav = t1.getElementById("nav");
      if (toggle != null)
        J._addEventListener$3$x(toggle, "click", type$.nullable_dynamic_Function_Event._as(new A.main_closure(nav)), null);
    },
